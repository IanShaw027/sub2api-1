...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	invoiceService := service.ProvideInvoiceService(client, configConfig, notificationEmailService)
