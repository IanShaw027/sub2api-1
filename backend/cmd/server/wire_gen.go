...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	grokOAuthService := service.NewGrokOAuthService(proxyRepository, grokOAuthClient).WithRedisSessionStore(redisClient)
	...
	oAuthService := service.NewOAuthService(proxyRepository, claudeOAuthClient).WithRedisSessionStore(redisClient)
	...
	antigravityOAuthService := service.NewAntigravityOAuthService(proxyRepository).WithRedisSessionStore(redisClient)
	...
	aiSkillRunService := service.ProvideAISkillRunService(aiSkillServiceRepositoryAdapter, aiSkillServiceRepositoryAdapter, aiSkillServiceRepositoryAdapter, aiSkillSettlementService, aiSkillRuntimeGateway, apiKeyRepository)
	...
	accountUsageService := service.NewAccountUsageService(accountRepository, usageLogRepository, claudeUsageFetcher, geminiQuotaService, antigravityQuotaFetcher, kiroTokenProvider, grokQuotaFetcher, openAIQuotaService, usageCache, identityCache, compositeTokenCacheInvalidator, proxyRepository, tlsFingerprintProfileService, settingService)
	...
	kiroOAuthService := service.NewKiroOAuthService(proxyRepository, httpUpstream, tlsFingerprintProfileService, settingService).WithRedisSessionStore(redisClient)
