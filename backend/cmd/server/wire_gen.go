...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountUsageService := service.NewAccountUsageService(accountRepository, usageLogRepository, claudeUsageFetcher, geminiQuotaService, antigravityQuotaFetcher, nil, usageCache, identityCache, compositeTokenCacheInvalidator, tlsFingerprintProfileService)
	...
	accountTestService := service.NewAccountTestService(accountRepository, geminiTokenProvider, nil, antigravityGatewayService, httpUpstream, configConfig, tlsFingerprintProfileService)
	...
	kiroOAuthService := service.NewKiroOAuthService(proxyRepository, httpUpstream, tlsFingerprintProfileService)
	kiroTokenRefresher := service.ProvideKiroTokenRefresher(httpUpstream, tlsFingerprintProfileService)
