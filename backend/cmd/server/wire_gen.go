...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	balanceCacheOutboxRepository := repository.NewBalanceCacheOutboxRepository(db)
	billingCacheService := service.ProvideBillingCacheService(billingCache, userRepository, userSubscriptionRepository, apiKeyRepository, userRPMCache, userGroupRateRepository, configConfig, serviceUserPlatformQuotaRepository, balanceCacheOutboxRepository)
	...
	apiKeyService, err := service.ProvideAPIKeyService(apiKeyRepository, userRepository, groupRepository, userSubscriptionRepository, userGroupRateRepository, apiKeyCache, configConfig, billingCacheService, concurrencyService, secretEncryptor)
	if err != nil {
		return nil, err
	}
	...
	kiroGatewayService := service.ProvideKiroGatewayService(httpUpstream, kiroTokenProvider, rateLimitService, tlsFingerprintProfileService, tlsFingerprintRouterService, settingService, channelService, fingerprintNormalizer)
	gatewayService := service.ProvideGatewayService(openAIGatewayService, accountRepository, groupRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, identityService, httpUpstream, deferredService, claudeTokenProvider, sessionLimitCache, rpmCache, digestSessionStore, settingService, tlsFingerprintProfileService, tlsFingerprintRouterService, channelService, modelPricingResolver, balanceNotifyService, kiroTokenProvider, kiroGatewayService, grokTokenProvider, serviceUserPlatformQuotaRepository, fingerprintNormalizer)
	geminiOAuthClient := repository.NewGeminiOAuthClient(configConfig)
	geminiCliCodeAssistClient := repository.NewGeminiCliCodeAssistClient()
	geminiOAuthService := service.ProvideGeminiOAuthService(proxyRepository, geminiOAuthClient, geminiCliCodeAssistClient, configConfig, redisClient)
	...
	antigravityGatewayService := service.ProvideAntigravityGatewayService(accountRepository, gatewayCache, schedulerSnapshotService, antigravityTokenProvider, rateLimitService, httpUpstream, settingService, internal500CounterCache, fingerprintNormalizer)
	...
	aiSkillDomainRepository := repository.ProvideAISkillDomainRepository(aiSkillRepository)
	aiSkillDomainService := service.ProvideAISkillDomainService(aiSkillDomainRepository)
	...
	aiSkillBalanceLedgerRepository := repository.NewAISkillBalanceLedgerRepository(db)
	aiSkillBalanceCharger := service.ProvideAISkillBalanceCharger(aiSkillBalanceLedgerRepository, userRepository, billingCacheService, balanceNotifyService)
	...
	aiSkillBillingAPIKeyLookup := service.ProvideAISkillBillingAPIKeyLookup(apiKeyRepository)
	aiSkillRunService := service.ProvideAISkillRunService(aiSkillServiceRepositoryAdapter, aiSkillServiceRepositoryAdapter, aiSkillServiceRepositoryAdapter, aiSkillSettlementService, aiSkillRuntimeGateway, aiSkillBillingAPIKeyLookup)
	module := handler.ProvideAISkillModule(db, aiSkillDomainService, aiSkillService, aiSkillVersionService, aiSkillReviewService, aiSkillSettlementService, aiSkillRunService)
	...
	apiKeyHandler := handler.ProvideAPIKeyHandler(apiKeyService, userService, totpService, settingService)
	...
	grokQuotaService := service.ProvideGrokQuotaService(accountRepository, proxyRepository, grokTokenProvider, httpUpstream, tlsFingerprintProfileService, settingService)
	...
	accountUsageService := service.NewAccountUsageService(accountRepository, usageLogRepository, claudeUsageFetcher, geminiQuotaService, antigravityQuotaFetcher, kiroTokenProvider, grokQuotaFetcher, grokQuotaService, openAIQuotaService, usageCache, identityCache, compositeTokenCacheInvalidator, proxyRepository, tlsFingerprintProfileService, settingService)
	...
	accountHandler := handler.ProvideAdminAccountHandler(adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, kiroTokenProvider, rateLimitService, accountUsageService, accountTestService, concurrencyService, crsSyncService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator, grokQuotaService)
	...
	kiroOAuthService := service.ProvideKiroOAuthService(proxyRepository, httpUpstream, tlsFingerprintProfileService, settingService, redisClient)
	...
	ipSecurityRepository := repository.NewIPSecurityRepository(db)
	ipSecurityService := service.ProvideIPSecurityService(ipSecurityRepository, settingRepository, redisClient)
	ipSecurityHandler := admin.NewIPSecurityHandler(ipSecurityService)
	...
	codexInviteResetService := service.ProvideCodexInviteResetService(adminService, httpUpstream, openAITokenProvider, tlsFingerprintProfileService, codexInviteResetHistoryRepository, tlsFingerprintRouterService)
	codexInviteResetHandler := admin.NewCodexInviteResetHandler(codexInviteResetService)
	adminHandlers := handler.ProvideAdminHandlers(adminAIHandler, dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, kiroOAuthHandler, grokOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, complianceHandler, opsHandler, systemHandler, adminSubscriptionHandler, affiliateHandler, adminTicketHandler, adminMediaHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, tlsFingerprintRouterHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, ipSecurityHandler, paymentHandler, codexInviteResetHandler)
	userMsgQueueCache := repository.NewUserMsgQueueCache(redisClient)
	userMessageQueueService := service.ProvideUserMessageQueueService(userMsgQueueCache, rpmCache, configConfig)
	gatewayHandler := handler.NewGatewayHandler(gatewayService, geminiMessagesCompatService, antigravityGatewayService, userService, concurrencyService, billingCacheService, usageService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, opsService, userMessageQueueService, configConfig, settingService)
	handlerSettingHandler := handler.ProvideSettingHandler(settingService, buildInfo, notificationEmailService)
	totpHandler := handler.NewTotpHandler(totpService)
	handlerPaymentHandler := handler.NewPaymentHandler(paymentService, paymentConfigService, invoiceService)
