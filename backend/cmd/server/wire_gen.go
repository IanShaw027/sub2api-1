...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	configuredAdminService := service.ConfigureAdminAccountCredentialRefreshers(adminService, oAuthRefreshAPI, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, kiroTokenRefresher, accountRepository)
	...
	proxyHandler := admin.NewProxyHandler(configuredAdminService)
	adminRedeemHandler := admin.NewRedeemHandler(configuredAdminService, redeemService)
