...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	authHandler := handler.ProvideAuthHandler(configConfig, authService, userService, settingService, promoService, redeemService, totpService, affiliateService)
	...
	ticketService := service.NewTicketService(ticketRepository, userRepository)
	...
	accountUsageService := service.NewAccountUsageService(accountRepository, usageLogRepository, claudeUsageFetcher, geminiQuotaService, antigravityQuotaFetcher, nil, usageCache, identityCache, compositeTokenCacheInvalidator, tlsFingerprintProfileService, settingService)
	...
	accountTestService := service.NewAccountTestService(accountRepository, geminiTokenProvider, nil, antigravityGatewayService, httpUpstream, configConfig, tlsFingerprintProfileService, settingService)
	...
	kiroTokenRefresher := service.ProvideKiroTokenRefresher(httpUpstream, tlsFingerprintProfileService, settingService)
	...
	kiroTokenProvider := service.ProvideKiroTokenProvider(accountRepository, geminiTokenCache, httpUpstream, tlsFingerprintProfileService, oAuthRefreshAPI, settingService)
	...
	accountUsageService = service.NewAccountUsageService(accountRepository, usageLogRepository, claudeUsageFetcher, geminiQuotaService, antigravityQuotaFetcher, kiroTokenProvider, usageCache, identityCache, compositeTokenCacheInvalidator, tlsFingerprintProfileService, settingService)
	accountTestService = service.NewAccountTestService(accountRepository, geminiTokenProvider, kiroTokenProvider, antigravityGatewayService, httpUpstream, configConfig, tlsFingerprintProfileService, settingService)
	...
	gatewayService.SetKiroDeps(kiroTokenProvider, kiroGatewayService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, kiroOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminTicketHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, paymentHandler)
