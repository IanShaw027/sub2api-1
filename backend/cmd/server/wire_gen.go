...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	kiroGatewayService := service.ProvideKiroGatewayService(httpUpstream, kiroTokenProvider, rateLimitService, tlsFingerprintProfileService, settingService, channelService)
	...
	capacityHandler := admin.NewCapacityHandler(capacityForecastService)
