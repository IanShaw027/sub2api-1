...
func TestLoadDefaultOpenAIWSConfig(t *testing.T) {
	...
	if cfg.Gateway.OpenAIWS.NeutralAcquireStaleIdleSeconds != 1000 {
		t.Fatalf("Gateway.OpenAIWS.NeutralAcquireStaleIdleSeconds = %d, want 1000", cfg.Gateway.OpenAIWS.NeutralAcquireStaleIdleSeconds)
	}
