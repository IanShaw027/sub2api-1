...
type RefundRequest struct {
	...
	Reason    string
	RequestID string // Stable provider idempotency key for this refund attempt.
}
...
type RefundQueryRequest struct {
	...
	RefundID  string
	Amount    string
	RequestID string // Stable provider idempotency key used as provider refund request id when supported.
}
