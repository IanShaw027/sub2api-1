		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeyDownloadToolsURL: "https://downloads.example.com/tools",
			...
			wantJSON: `{
				...
				"data": {
					...
					"anti_ban_platforms": {"anthropic":false,"antigravity":false,"gemini":false,"grok":false,"kiro":false,"openai":false},
