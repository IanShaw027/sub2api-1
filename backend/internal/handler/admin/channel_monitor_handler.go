...
type channelMonitorCreateRequest struct {
	...
	Provider         string            `json:"provider" binding:"required,oneof=openai anthropic gemini kiro grok"`
...
type channelMonitorUpdateRequest struct {
	...
	Provider         *string            `json:"provider" binding:"omitempty,oneof=openai anthropic gemini kiro grok"`
	APIMode          *string            `json:"api_mode" binding:"omitempty,oneof=chat_completions responses"`
