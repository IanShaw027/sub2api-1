...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		IPMultiAccountBanWindow2Minutes: settings.IPMultiAccountBanWindow2Minutes,
		IPMultiAccountBanThreshold2:     settings.IPMultiAccountBanThreshold2,
		IPMultiAccountBanLearningUntil:  settings.IPMultiAccountBanLearningUntil,
		RegistrationBlockDatacenterIP:   settings.RegistrationBlockDatacenterIP,
