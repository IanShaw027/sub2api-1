...
// ProxyFromServiceAdmin converts a service Proxy to a redacted admin DTO.
...
// ProxyWithAccountCountFromServiceAdmin converts a service ProxyWithAccountCount to a redacted admin DTO.
