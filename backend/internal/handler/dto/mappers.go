...
func UserFromServiceAdmin(u *service.User) *AdminUser {
	...
	return &AdminUser{
		...
		TodayBalanceActualCost:      u.TodayBalanceActualCost,
		TodaySubscriptionActualCost: u.TodaySubscriptionActualCost,
		TotalActualCost:             u.TotalActualCost,
...
func groupFromServiceBase(g *service.Group) Group {
	...
	return Group{
		...
		ImageGenerationRoute: g.EffectiveImageGenerationRoute(),
		OpenAIImageMainModel: g.EffectiveOpenAIImageMainModel(),
		...
		VideoGenerationRoute:  g.EffectiveVideoGenerationRoute(),
		VideoPrice480pPerSec:  g.VideoPrice480pPerSec,
...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	out := &Account{
		...
		OpenAIImageGenerationEnabled: a.OpenAIImageGenerationAllowed(),
		ProxyID:                      a.ProxyID,
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		OpenAIWSProfile:              l.OpenAIWSProfile,
		OpenAIWSConnReused:           l.OpenAIWSConnReused,
		...
		VideoUnitPrice:               l.VideoUnitPrice,
...
func UsageCleanupTaskFromService(task *service.UsageCleanupTask) *UsageCleanupTask {
	...
	return &UsageCleanupTask{
		...
		Filters: UsageCleanupFilters{
			...
			ExcludeAdmin: task.Filters.ExcludeAdmin,
		},
