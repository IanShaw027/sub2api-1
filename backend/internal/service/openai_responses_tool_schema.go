...
func shouldSanitizeOpenAIResponsesToolSchemaPatterns(account *Account) bool {
	return account != nil && shouldSanitizeOpenAIResponsesToolSchemaPatternsByPlatform(account.Platform)
}

func shouldSanitizeOpenAIResponsesToolSchemaPatternsByPlatform(platform string) bool {
...
func sanitizeOpenAIResponsesToolSchemasForPlatform(body []byte, platform string) ([]byte, bool, error) {
	...
	if shouldSanitizeOpenAIResponsesToolSchemaPatternsByPlatform(platform) {
