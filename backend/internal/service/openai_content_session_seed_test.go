...
func TestDeriveOpenAIStablePrefixSessionSeed_ChatSystemAndDeveloper(t *testing.T) {
	...
	require.NotContains(t, firstSeed, "System prompt")
	require.NotContains(t, firstSeed, "Developer prompt")
	require.Len(t, firstSeed, len(contentStablePrefixSessionSeedPrefix)+32)
}
...
func TestDeriveOpenAIStablePrefixSessionSeed_EncodesSystemAndDeveloperRoles(t *testing.T) {
	...
	require.NotContains(t, firstSeed, "Prompt A")
	require.NotContains(t, firstSeed, "Prompt B")
}
