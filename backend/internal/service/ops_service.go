...
func (s *OpsService) GetUserErrorRequestDetail(ctx context.Context, userID int64, errorID int64) (*UserErrorRequestDetail, error) {
	if errorID <= 0 {
	...
	detail, err := s.opsRepo.GetErrorLogByID(ctx, errorID)
	if err != nil {
