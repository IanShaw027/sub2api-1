...
type AccountUsageService struct {
	...
	usageLogRepo       AccountUsageRepository
	usageFetcher       ClaudeUsageFetcher
	geminiQuotaService *GeminiQuotaService
}

// NewAccountUsageService 创建AccountUsageService实例
func NewAccountUsageService(accountRepo AccountRepository, usageLogRepo AccountUsageRepository, usageFetcher ClaudeUsageFetcher, geminiQuotaService *GeminiQuotaService) *AccountUsageService {
