...
func TestGeminiMessagesCompatService_SelectAccountForAIStudioEndpoints_AcceptsGoogleOneOAuth(t *testing.T) {
	ctx := context.Background()
	...
	require.Equal(t, "google_one", acc.GeminiOAuthTypeSafe())
}
