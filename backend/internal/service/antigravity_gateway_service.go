...
func (s *AntigravityGatewayService) SetTLSFingerprintServices(profile *TLSFingerprintProfileService, router *TLSFingerprintRouterService) {
	if s == nil {
		return
	}
...
func (s *AntigravityGatewayService) doAccountHTTP(ctx context.Context, account *Account, req *http.Request, proxyURL, inboundUA string) (*http.Response, error) {
	return doAccountHTTPUpstream(ctx, s.httpUpstream, req, proxyURL, account, s.tlsFPProfileService, s.tlsFPRouterService, inboundUA, "http", "antigravity")
}
