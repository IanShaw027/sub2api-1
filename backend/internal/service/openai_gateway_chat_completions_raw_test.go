...
func TestBuildOpenAIChatCompletionsURL(t *testing.T) {
	...
	tests := []struct {
		...
		{"endpoint-style responses url", "https://api.openai.com/v1/responses", "https://api.openai.com/v1/chat/completions"},
		{"endpoint-style bare responses url", "https://upstream.example/responses", "https://upstream.example/chat/completions"},
		// 带空白字符
