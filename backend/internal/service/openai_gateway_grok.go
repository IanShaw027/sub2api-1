...
func (s *OpenAIGatewayService) forwardGrokResponsesWithPromptCacheKey(
	...
	// Single egress for Grok text Responses: active-delta + retries + binds (P2).
	return s.doGrokResponsesUpstream(ctx, c, account, patchedBody, originalModel, upstreamModel, cacheIdentity, reqStream, startTime)
}
