...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		...
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			ImageGenerationRoute:            group.EffectiveImageGenerationRoute(),
			OpenAIImageMainModel:            group.EffectiveOpenAIImageMainModel(),
			...
			Images2APIPrice1K:               group.Images2APIPrice1K,
			Images2APIPrice2K:               group.Images2APIPrice2K,
			Images2APIPrice4K:               group.Images2APIPrice4K,
			AllowVideoGeneration:            group.AllowVideoGeneration,
			VideoGenerationRoute:            group.EffectiveVideoGenerationRoute(),
			VideoPrice480pPerSec:            group.VideoPrice480pPerSec,
