...
func TestClassifyImageBillingTier(t *testing.T) {
	tests := []struct {
		...
		{name: "custom 1024x768 stays 1k by max edge threshold", size: "1024X768", wantTier: "1K", wantOK: true},
		{name: "parseable invalid custom size uses native 2k floor", size: "512x512", wantTier: "2K", wantOK: true},
		{name: "long edge 2k", size: "1280x768", wantTier: "2K", wantOK: true},
		{name: "custom 2560x1440 upgrades to 4k by max edge threshold", size: "2560x1440", wantTier: "4K", wantOK: true},
