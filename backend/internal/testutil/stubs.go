...
func (c StubGatewayCache) GetOpenAIResponsesSessionWindow(_ context.Context, _ int64, _ string) ([]byte, error) {
	return nil, nil
}
func (c StubGatewayCache) SetOpenAIResponsesSessionWindow(_ context.Context, _ int64, _ string, _ []byte, _ time.Duration) error {
	return nil
}
func (c StubGatewayCache) DeleteOpenAIResponsesSessionWindow(_ context.Context, _ int64, _ string) error {
	return nil
}
