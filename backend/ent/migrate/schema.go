...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "lookup_hash", Type: field.TypeString, Unique: true, Nullable: true, Size: 64},
		{Name: "key_ciphertext", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
	...
	ChannelMonitorsColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "name", Type: field.TypeString, Size: 100},
		{Name: "provider", Type: field.TypeEnum, Enums: []string{"openai", "anthropic", "gemini", "kiro", "grok"}},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "video_generation_route", Type: field.TypeString, Size: 20, Default: "native"},
		{Name: "video_price_480p_per_sec", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "video_price_720p_per_sec", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "video_price_1080p_per_sec", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "video_price_4k_per_sec", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "fulfillment_lease_token", Type: field.TypeString, Size: 64, Default: ""},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "video_resolution", Type: field.TypeString, Nullable: true, Size: 20},
		{Name: "video_seconds", Type: field.TypeInt, Nullable: true},
		{Name: "video_count", Type: field.TypeInt, Default: 0},
		{Name: "video_unit_price", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "balance", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(22,10)"}},
		{Name: "frozen_balance", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(22,10)"}},
