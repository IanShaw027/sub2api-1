...
func init() {
	...
	supportticket.DefaultCurrentFormPayload = supportticketDescCurrentFormPayload.Default.(jsontext.Value)
	...
	supportticketmessage.DefaultAttachments = supportticketmessageDescAttachments.Default.(jsontext.Value)
	...
	supportticketrevision.DefaultFormPayload = supportticketrevisionDescFormPayload.Default.(jsontext.Value)
