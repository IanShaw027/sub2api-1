...
func init() {
	...
	// apikeyDescLookupHash is the schema descriptor for lookup_hash field.
	apikeyDescLookupHash := apikeyFields[2].Descriptor()
	// apikey.LookupHashValidator is a validator for the "lookup_hash" field. It is called by the builders before save.
	apikey.LookupHashValidator = apikeyDescLookupHash.Validators[0].(func(string) error)
	...
	groupDescUserSelectable := groupFields[10].Descriptor()
	...
	groupDescImageGenerationRoute := groupFields[20].Descriptor()
	...
	groupDescOpenaiImageMainModel := groupFields[21].Descriptor()
	...
	groupDescImagePrice1k := groupFields[24].Descriptor()
	...
	groupDescImagePrice2k := groupFields[25].Descriptor()
	...
	groupDescImagePrice4k := groupFields[26].Descriptor()
	...
	groupDescImages2apiPrice1k := groupFields[27].Descriptor()
	...
	groupDescImages2apiPrice2k := groupFields[28].Descriptor()
	...
	groupDescImages2apiPrice4k := groupFields[29].Descriptor()
	...
	// group.BatchImageDiscountMultiplierValidator is a validator for the "batch_image_discount_multiplier" field. It is called by the builders before save.
	group.BatchImageDiscountMultiplierValidator = groupDescBatchImageDiscountMultiplier.Validators[0].(func(float64) error)
	...
	// group.BatchImageHoldMultiplierValidator is a validator for the "batch_image_hold_multiplier" field. It is called by the builders before save.
	group.BatchImageHoldMultiplierValidator = groupDescBatchImageHoldMultiplier.Validators[0].(func(float64) error)
	...
	// group.VideoRateMultiplierValidator is a validator for the "video_rate_multiplier" field. It is called by the builders before save.
	group.VideoRateMultiplierValidator = groupDescVideoRateMultiplier.Validators[0].(func(float64) error)
	// groupDescAllowVideoGeneration is the schema descriptor for allow_video_generation field.
	groupDescAllowVideoGeneration := groupFields[34].Descriptor()
	...
	// groupDescVideoGenerationRoute is the schema descriptor for video_generation_route field.
	groupDescVideoGenerationRoute := groupFields[35].Descriptor()
	// group.DefaultVideoGenerationRoute holds the default value on creation for the video_generation_route field.
	...
	groupDescVideoPrice480pPerSec := groupFields[36].Descriptor()
	...
	groupDescVideoPrice720pPerSec := groupFields[37].Descriptor()
	...
	groupDescVideoPrice1080pPerSec := groupFields[38].Descriptor()
	...
	groupDescVideoPrice4kPerSec := groupFields[39].Descriptor()
	...
	// groupDescVideoPrice480p is the schema descriptor for video_price_480p field.
	groupDescVideoPrice480p := groupFields[40].Descriptor()
	// group.VideoPrice480pValidator is a validator for the "video_price_480p" field. It is called by the builders before save.
	group.VideoPrice480pValidator = groupDescVideoPrice480p.Validators[0].(func(float64) error)
	// groupDescVideoPrice720p is the schema descriptor for video_price_720p field.
	groupDescVideoPrice720p := groupFields[41].Descriptor()
	// group.VideoPrice720pValidator is a validator for the "video_price_720p" field. It is called by the builders before save.
	group.VideoPrice720pValidator = groupDescVideoPrice720p.Validators[0].(func(float64) error)
	// groupDescVideoPrice1080p is the schema descriptor for video_price_1080p field.
	groupDescVideoPrice1080p := groupFields[42].Descriptor()
	// group.VideoPrice1080pValidator is a validator for the "video_price_1080p" field. It is called by the builders before save.
	group.VideoPrice1080pValidator = groupDescVideoPrice1080p.Validators[0].(func(float64) error)
	...
	paymentorderDescFulfillmentLeaseToken := paymentorderFields[37].Descriptor()
	// paymentorder.DefaultFulfillmentLeaseToken holds the default value on creation for the fulfillment_lease_token field.
	paymentorder.DefaultFulfillmentLeaseToken = paymentorderDescFulfillmentLeaseToken.Default.(string)
	...
	// tlsfingerprintprofileDescOs is the schema descriptor for os field.
	tlsfingerprintprofileDescOs := tlsfingerprintprofileFields[3].Descriptor()
	// tlsfingerprintprofile.DefaultOs holds the default value on creation for the os field.
	tlsfingerprintprofile.DefaultOs = tlsfingerprintprofileDescOs.Default.(string)
	// tlsfingerprintprofile.OsValidator is a validator for the "os" field. It is called by the builders before save.
	tlsfingerprintprofile.OsValidator = tlsfingerprintprofileDescOs.Validators[0].(func(string) error)
	// tlsfingerprintprofileDescClientType is the schema descriptor for client_type field.
	tlsfingerprintprofileDescClientType := tlsfingerprintprofileFields[4].Descriptor()
	// tlsfingerprintprofile.DefaultClientType holds the default value on creation for the client_type field.
	tlsfingerprintprofile.DefaultClientType = tlsfingerprintprofileDescClientType.Default.(string)
	// tlsfingerprintprofile.ClientTypeValidator is a validator for the "client_type" field. It is called by the builders before save.
	tlsfingerprintprofile.ClientTypeValidator = tlsfingerprintprofileDescClientType.Validators[0].(func(string) error)
	// tlsfingerprintprofileDescUserAgent is the schema descriptor for user_agent field.
	tlsfingerprintprofileDescUserAgent := tlsfingerprintprofileFields[5].Descriptor()
	...
	tlsfingerprintprofileDescOriginator := tlsfingerprintprofileFields[6].Descriptor()
	...
	usagelogDescOpenaiWsProfile := usagelogFields[45].Descriptor()
	...
	usagelogDescOpenaiWsConnReused := usagelogFields[46].Descriptor()
	...
	usagelogDescProvider := usagelogFields[47].Descriptor()
	...
	userDescTokenVersion := userFields[21].Descriptor()
