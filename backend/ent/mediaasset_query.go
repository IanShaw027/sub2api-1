...
func (_q *MediaAssetQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *MediaAssetQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *MediaAssetQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *MediaAssetQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *MediaAssetQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *MediaAssetQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(mediaasset.FieldOwnerUserID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.MediaAsset.Query().
//		Select(mediaasset.FieldOwnerUserID).
//		Scan(ctx, &v)
...
func (_q *MediaAssetQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(mediaasset.Table, mediaasset.Columns, sqlgraph.NewFieldSpec(mediaasset.FieldID, field.TypeInt64))
	_spec.From = _q.sql
