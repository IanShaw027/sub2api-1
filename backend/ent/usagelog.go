...
type UsageLog struct {
	...
	// VideoUnitPrice holds the value of the "video_unit_price" field.
	...
	// OpenaiWsProfile holds the value of the "openai_ws_profile" field.
	OpenaiWsProfile string `json:"openai_ws_profile,omitempty"`
	// OpenaiWsConnReused holds the value of the "openai_ws_conn_reused" field.
...
func (*UsageLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usagelog.FieldImageSizeBreakdown:
			values[i] = new([]byte)
		case usagelog.FieldLongContextBillingApplied, usagelog.FieldStream, usagelog.FieldCacheTTLOverridden, usagelog.FieldOpenaiWsConnReused:
			values[i] = new(sql.NullBool)
		case usagelog.FieldInputCost, usagelog.FieldOutputCost, usagelog.FieldCacheCreationCost, usagelog.FieldCacheReadCost, usagelog.FieldTotalCost, usagelog.FieldActualCost, usagelog.FieldRateMultiplier, usagelog.FieldAccountRateMultiplier, usagelog.FieldVideoUnitPrice:
			values[i] = new(sql.NullFloat64)
		case usagelog.FieldID, usagelog.FieldUserID, usagelog.FieldAPIKeyID, usagelog.FieldAccountID, usagelog.FieldChannelID, usagelog.FieldGroupID, usagelog.FieldSubscriptionID, usagelog.FieldInputTokens, usagelog.FieldOutputTokens, usagelog.FieldCacheCreationTokens, usagelog.FieldCacheReadTokens, usagelog.FieldCacheCreation5mTokens, usagelog.FieldCacheCreation1hTokens, usagelog.FieldBillingType, usagelog.FieldDurationMs, usagelog.FieldFirstTokenMs, usagelog.FieldImageCount, usagelog.FieldVideoSeconds, usagelog.FieldVideoCount:
			values[i] = new(sql.NullInt64)
		case usagelog.FieldRequestID, usagelog.FieldModel, usagelog.FieldRequestedModel, usagelog.FieldUpstreamModel, usagelog.FieldModelMappingChain, usagelog.FieldBillingTier, usagelog.FieldBillingMode, usagelog.FieldUserAgent, usagelog.FieldIPAddress, usagelog.FieldImageSize, usagelog.FieldImageInputSize, usagelog.FieldImageOutputSize, usagelog.FieldImageSizeSource, usagelog.FieldVideoResolution, usagelog.FieldOpenaiWsProfile, usagelog.FieldProvider:
	...
	for i := range columns {
		...
		case usagelog.FieldVideoSeconds:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				_m.VideoSeconds = new(int)
				*_m.VideoSeconds = int(value.Int64)
			}
		...
		case usagelog.FieldVideoUnitPrice:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field video_unit_price", values[i])
			} else if value.Valid {
				_m.VideoUnitPrice = new(float64)
				*_m.VideoUnitPrice = value.Float64
			}
		...
		case usagelog.FieldOpenaiWsProfile:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field openai_ws_profile", values[i])
			} else if value.Valid {
				_m.OpenaiWsProfile = value.String
			}
		case usagelog.FieldOpenaiWsConnReused:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field openai_ws_conn_reused", values[i])
			} else if value.Valid {
				_m.OpenaiWsConnReused = value.Bool
			}
...
func (_m *UsageLog) String() string {
	...
	builder.WriteString(", ")
	if v := _m.VideoUnitPrice; v != nil {
		builder.WriteString("video_unit_price=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	builder.WriteString("openai_ws_profile=")
	builder.WriteString(_m.OpenaiWsProfile)
	builder.WriteString(", ")
	builder.WriteString("openai_ws_conn_reused=")
	builder.WriteString(fmt.Sprintf("%v", _m.OpenaiWsConnReused))
	builder.WriteString(", ")
