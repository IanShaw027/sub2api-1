...
const (
	...
	// FieldVideoUnitPrice holds the string denoting the video_unit_price field in the database.
	FieldVideoUnitPrice = "video_unit_price"
...
// ByVideoUnitPrice orders the results by the video_unit_price field.
func ByVideoUnitPrice(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldVideoUnitPrice, opts...).ToFunc()
}
