...
const (
	// Label holds the string label denoting the opsmetricshourly type in the database.
	Label = "ops_metrics_hourly"
	...
	// Table holds the table name of the opsmetricshourly in the database.
	Table = "ops_metrics_hourly"
)

// Columns holds all SQL columns for opsmetricshourly fields.
var Columns = []string{
	FieldID,
	FieldBucketStart,
	FieldPlatform,
...
// OrderOption defines the ordering options for the OpsMetricsHourly queries.
