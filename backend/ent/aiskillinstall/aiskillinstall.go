...
const (
	// Label holds the string label denoting the aiskillinstall type in the database.
	Label = "ai_skill_install"
	...
	EdgeUser = "user"
	// Table holds the table name of the aiskillinstall in the database.
	Table = "ai_skill_installs"
	// SkillTable is the table that holds the skill relation/edge.
	SkillTable = "ai_skill_installs"
...
// Columns holds all SQL columns for aiskillinstall fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the AISkillInstall queries.
