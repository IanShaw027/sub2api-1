...
type Group struct {
	...
	// 前台是否允许用户直接选择该线路
	UserSelectable bool `json:"user_selectable,omitempty"`
	...
	// Images2apiPrice1k holds the value of the "images2api_price_1k" field.
	Images2apiPrice1k *float64 `json:"images2api_price_1k,omitempty"`
	// Images2apiPrice2k holds the value of the "images2api_price_2k" field.
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldModelRouting, group.FieldSupportedModelScopes, group.FieldMessagesDispatchModelConfig, group.FieldModelsListConfig:
			values[i] = new([]byte)
		case group.FieldPeakRateEnabled, group.FieldIsExclusive, group.FieldUserSelectable, group.FieldAllowImageGeneration, group.FieldAllowBatchImageGeneration, group.FieldImageRateIndependent, group.FieldVideoRateIndependent, group.FieldAllowVideoGeneration, group.FieldClaudeCodeOnly, group.FieldModelRoutingEnabled, group.FieldMcpXMLInject, group.FieldAllowMessagesDispatch, group.FieldRequireOauthOnly, group.FieldRequirePrivacySet:
			values[i] = new(sql.NullBool)
		case group.FieldRateMultiplier, group.FieldRefundRateMultiplier, group.FieldPeakRateMultiplier, group.FieldDailyLimitUsd, group.FieldWeeklyLimitUsd, group.FieldMonthlyLimitUsd, group.FieldImageRateMultiplier, group.FieldImagePrice1k, group.FieldImagePrice2k, group.FieldImagePrice4k, group.FieldImages2apiPrice1k, group.FieldImages2apiPrice2k, group.FieldImages2apiPrice4k, group.FieldBatchImageDiscountMultiplier, group.FieldBatchImageHoldMultiplier, group.FieldVideoRateMultiplier, group.FieldVideoPrice480pPerSec, group.FieldVideoPrice720pPerSec, group.FieldVideoPrice1080pPerSec, group.FieldVideoPrice4kPerSec, group.FieldVideoPrice480p, group.FieldVideoPrice720p, group.FieldVideoPrice1080p, group.FieldWebSearchPricePerCall, group.FieldSearchPricePer1k, group.FieldAudioRealtimePricePerMin, group.FieldAudioTtsPricePerMillionChars, group.FieldAudioSttPricePerHour:
			values[i] = new(sql.NullFloat64)
		case group.FieldID, group.FieldDefaultValidityDays, group.FieldFallbackGroupID, group.FieldFallbackGroupIDOnInvalidRequest, group.FieldSortOrder, group.FieldRpmLimit:
			values[i] = new(sql.NullInt64)
		case group.FieldName, group.FieldDisplayName, group.FieldDescription, group.FieldPeakStart, group.FieldPeakEnd, group.FieldStatus, group.FieldPlatform, group.FieldSubscriptionType, group.FieldImageGenerationRoute, group.FieldOpenaiImageMainModel, group.FieldVideoGenerationRoute, group.FieldDefaultMappedModel:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldRefundRateMultiplier:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field refund_rate_multiplier", values[i])
			} else if value.Valid {
				_m.RefundRateMultiplier = value.Float64
			}
		...
		case group.FieldUserSelectable:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field user_selectable", values[i])
			} else if value.Valid {
				_m.UserSelectable = value.Bool
			}
		...
		case group.FieldImageGenerationRoute:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field image_generation_route", values[i])
			} else if value.Valid {
				_m.ImageGenerationRoute = value.String
			}
		case group.FieldOpenaiImageMainModel:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field openai_image_main_model", values[i])
			} else if value.Valid {
				_m.OpenaiImageMainModel = value.String
			}
		...
		case group.FieldImages2apiPrice1k:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field images2api_price_1k", values[i])
			} else if value.Valid {
				_m.Images2apiPrice1k = new(float64)
				*_m.Images2apiPrice1k = value.Float64
			}
		case group.FieldImages2apiPrice2k:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field images2api_price_2k", values[i])
			} else if value.Valid {
				_m.Images2apiPrice2k = new(float64)
				*_m.Images2apiPrice2k = value.Float64
			}
		case group.FieldImages2apiPrice4k:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field images2api_price_4k", values[i])
			} else if value.Valid {
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("refund_rate_multiplier=")
	builder.WriteString(fmt.Sprintf("%v", _m.RefundRateMultiplier))
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	builder.WriteString("user_selectable=")
	builder.WriteString(fmt.Sprintf("%v", _m.UserSelectable))
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	builder.WriteString("image_generation_route=")
	builder.WriteString(_m.ImageGenerationRoute)
	builder.WriteString(", ")
	builder.WriteString("openai_image_main_model=")
	builder.WriteString(_m.OpenaiImageMainModel)
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	if v := _m.Images2apiPrice1k; v != nil {
		builder.WriteString("images2api_price_1k=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	if v := _m.Images2apiPrice2k; v != nil {
		builder.WriteString("images2api_price_2k=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
