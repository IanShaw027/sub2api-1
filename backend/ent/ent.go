...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			tlsfingerprintcapturesample.Table:       tlsfingerprintcapturesample.ValidColumn,
			tlsfingerprintcapturesession.Table:      tlsfingerprintcapturesession.ValidColumn,
			tlsfingerprintcapturesessionevent.Table: tlsfingerprintcapturesessionevent.ValidColumn,
			tlsfingerprintcapturetask.Table:         tlsfingerprintcapturetask.ValidColumn,
