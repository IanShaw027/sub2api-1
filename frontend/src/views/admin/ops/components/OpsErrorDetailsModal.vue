      ...
      <div class="mb-4 flex-shrink-0 border-b border-line pb-4 ">
        <div class="grid grid-cols-2 gap-2 md:grid-cols-8">
          ...
          <div class="flex items-center justify-end">
            <button type="button" class="rounded-lg bg-surface-2 px-3 py-1.5 text-xs font-semibold text-foreground transition-colors hover:bg-surface-3   " @click="resetFilters">
              {{ t('common.reset') }}
            </button>
          </div>
        </div>
