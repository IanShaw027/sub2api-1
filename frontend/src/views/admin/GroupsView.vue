<template>
  <AppLayout>
    <TablePageLayout>
      <template #filters>
        <div
          class="flex flex-col justify-between gap-4 rounded-card border border-line bg-card p-3 shadow-xs dark:border-dark-700 dark:bg-dark-800/50 lg:flex-row lg:items-center"
        >
          ...
          >
            ...
            <div class="relative" ref="columnDropdownRef">
              ...
              <div
                ...
                class="absolute right-0 top-full z-50 mt-1 max-h-80 w-48 overflow-y-auto rounded-card border border-line bg-card py-1 shadow-md dark:border-dark-600 dark:bg-dark-800"
              >
                <button
                  v-for="col in toggleableColumns"
                  :key="col.key"
                  @click="toggleColumn(col.key)"
                  class="flex w-full items-center justify-between px-4 py-2 text-left text-sm text-ink hover:bg-page dark:hover:bg-dark-700"
                >
                  <span>{{ col.label }}</span>
                  <Icon
                  ...
                  : value === 'openai'
                    ...
                    : value === 'antigravity'
                      ...
                      : value === 'grok'
                        ...
                        : 'bg-accent-100 text-accent-700 dark:bg-blue-900/30 dark:text-blue-400',
              ]"
            >
 ...
 : 'bg-page text-ink-body dark:bg-dark-700',
                ]"
              >
                {{
                  row.subscription_type === "subscription"
 ...
 class="space-y-0.5 text-xs text-ink-soft"
              >
                <div
                  v-if="
                    row.daily_limit_usd ||
                ...
                >
                  <span v-if="row.daily_limit_usd" class="whitespace-nowrap">
                    <span v-if="usageLoading" class="font-medium text-ink-faint">—</span>
                    <span
                      v-else
                      :class="getQuotaUsageClass(usageMap.get(row.id)?.today_cost ?? 0, row.daily_limit_usd)"
 ...
 <span class="ml-1 font-medium text-ink-body">
 ...
 <span class="text-ink-soft">{{
                ...
                >
                <span
 class="ml-1 inline-flex items-center rounded bg-page px-1.5 py-0.5 font-medium text-ink dark:bg-dark-600"
 ...
 <span class="text-ink-soft">{{
                ...
                <span
 class="ml-1 font-medium text-ink-body"
 ...
 class="ml-1 inline-flex items-center rounded bg-page px-1.5 py-0.5 font-medium text-ink dark:bg-dark-600"
          ...
          <template #cell-usage="{ row }">
            <div v-if="usageLoading" class="text-xs text-ink-faint">—</div>
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-ink-soft transition-colors hover:bg-page hover:text-brand-600 dark:hover:bg-dark-700 dark:hover:text-brand-400"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-ink-soft transition-colors hover:bg-page hover:text-purple-600 dark:hover:bg-dark-700 dark:hover:text-purple-400"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-ink-soft transition-colors hover:bg-page hover:text-orange-600 dark:hover:bg-dark-700 dark:hover:text-orange-400"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-ink-soft transition-colors hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-900/20 dark:hover:text-red-400"
              >
 ...
 <label class="text-sm font-medium text-ink-body">
            ...
            <div class="group relative inline-flex">
              <Icon
                ...
                size="sm"
                :stroke-width="2"
                class="cursor-help text-ink-faint transition-colors hover:text-brand-500 dark:hover:text-brand-400"
              />
              <div
                class="pointer-events-none absolute bottom-full left-0 z-50 mb-2 w-72 opacity-0 transition-all duration-150 group-hover:pointer-events-auto group-hover:opacity-100"
              >
                <div
                  class="rounded-lg bg-ink p-3 text-white shadow-lg dark:bg-dark-800"
                >
                  <p class="text-xs leading-relaxed text-ink-faint">
                    {{ t("admin.groups.copyAccounts.tooltip") }}
                  </p>
                  <div
                    class="absolute -bottom-1.5 left-3 h-3 w-3 rotate-45 bg-ink dark:bg-dark-800"
                  ></div>
                </div>
              </div>
            </div>
          ...
          >
            <span
              ...
              :key="groupId"
              class="inline-flex items-center gap-1 rounded-full bg-brand-100 px-2.5 py-1 text-xs font-medium text-brand-700 dark:bg-brand-900/30 dark:text-brand-300"
            >
              {{
              ...
              <button
                ...
                "
                class="ml-0.5 text-brand-500 hover:text-brand-700 dark:hover:text-brand-200"
              >
                <Icon name="x" size="xs" />
              </button>
            </span>
            ...
            <div class="group relative inline-flex">
              ...
              >
                ...
                >
                  ...
                  <p class="mb-2 text-xs leading-relaxed text-ink-faint">
                    {{ t("admin.groups.exclusiveTooltip.description") }}
                  </p>
                  <div class="rounded bg-ink p-2 dark:bg-dark-700">
                    <p class="text-xs leading-relaxed text-ink-faint">
                      <span
 ...
 <span class="text-sm text-ink-soft">
        ...
        <div class="mt-4 border-t pt-4">
          ...
          <div
            v-if="createForm.subscription_type === 'subscription'"
            class="space-y-4 border-l-2 border-brand-200 pl-4 dark:border-brand-800"
          >
            <div>
 ...
 <p class="mt-1 text-xs text-ink-soft">
          ...
          <div
            ...
            class="overflow-hidden rounded-lg border border-line bg-page/50 dark:border-dark-600 dark:bg-dark-800/40"
          >
            <div
              v-if="!createModelsListLoading && createModelsListState.items.length > 0"
              class="flex items-center justify-between gap-2 border-b border-line bg-page px-3 py-2 text-xs dark:border-dark-600 dark:bg-dark-800"
            >
 <span class="text-ink-soft">
                {{
              ...
              <div class="flex items-center gap-1.5">
                <button
                  type="button"
                  class="rounded px-2 py-1 font-medium text-brand-600 transition-colors hover:bg-brand-50 dark:text-brand-400 dark:hover:bg-brand-900/20"
                ...
                <button
                  type="button"
 class="rounded px-2 py-1 font-medium text-ink-body transition-colors hover:bg-page dark:hover:bg-dark-700"
            ...
            >
 <p v-if="createModelsListLoading" class="text-xs text-ink-soft">
 ...
 class="text-xs text-ink-soft"
              ...
              <div
                ...
                :key="item.id"
                class="flex items-center gap-2 rounded border border-line bg-white px-3 py-2 dark:border-dark-600 dark:bg-dark-800"
              >
                <input
                ...
                />
 <span class="min-w-0 flex-1 break-all text-sm text-ink-body">
                  {{ item.id }}
                </span>
                <button
                  type="button"
                  :disabled="index === 0"
                  class="rounded p-1 text-ink-faint hover:bg-page hover:text-ink-body disabled:opacity-40 dark:hover:bg-dark-600 dark:hover:text-ink"
        ...
        >
          <label
 class="block mb-2 font-medium text-ink-body"
          >
 ...
 <label class="mb-4 flex items-center gap-2 text-sm text-ink-body">
              <input
                v-model="createForm.allow_image_generation"
                type="checkbox"
                class="rounded border-line text-brand-600 focus:ring-accent/25"
              />
 ...
 <div class="mb-3 text-xs font-medium text-ink-soft">
                  {{ t("admin.groups.imagePricing.routeNative", "native") }}
                </div>
 ...
 <div class="mt-2 rounded-lg bg-page p-3 text-xs text-ink-body dark:bg-dark-800">
              <div class="mb-1 font-medium">
                {{ t("admin.groups.imagePricing.finalPricePreview") }}
              </div>
              <div class="space-y-2">
                <div>
 <div class="mb-1 text-[11px] font-medium text-ink-soft">
                    {{ t("admin.groups.imagePricing.images") }}
                  </div>
 ...
 <label class="block mb-2 font-medium text-ink-body">
          ...
          <div class="space-y-2">
            <label class="flex items-center gap-2 cursor-pointer">
              <input
                ...
                class="h-4 w-4 rounded border-line text-brand-600 focus:ring-accent/25 dark:border-dark-600 dark:bg-dark-700"
              />
 <span class="text-sm text-ink-body">{{
 ...
 <h4 class="mb-3 text-sm font-medium text-ink-body">
        ...
        <div
          ...
          class="border-t border-line dark:border-dark-400 pt-4 mt-4"
        >
 <h4 class="text-sm font-medium text-ink-body mb-3">
            {{ t("admin.groups.openaiMessages.title") }}
          </h4>

          <!-- 允许 Messages 调度开关 -->
          <div class="flex items-center justify-between">
 <label class="text-sm text-ink-body">{{
            ...
            <button
              ...
              @click="
                createForm.allow_messages_dispatch =
                  !createForm.allow_messages_dispatch
              "
              class="relative inline-flex h-6 w-12 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus:outline-none"
              :class="
                createForm.allow_messages_dispatch
                  ? 'bg-brand-500'
                  : 'bg-line dark:bg-dark-600'
            ...
            >
              <span
                class="pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-150 ease-in-out"
                :class="
                  createForm.allow_messages_dispatch
                    ? 'translate-x-6'
                    : 'translate-x-1'
 ...
 <p class="text-xs text-ink-soft mt-1">
          ...
          <div v-if="createForm.allow_messages_dispatch" class="mt-3">
            <div
              class="relative overflow-hidden rounded-xl border border-line bg-white shadow-xs dark:border-dark-600 dark:bg-dark-800"
            >
              <div
                class="border-b border-line bg-page/80 px-4 py-3 dark:border-dark-700 dark:bg-dark-700/50"
              >
 ...
 <p class="mt-1 text-xs text-ink-soft">
            ...
            <div
              class="mt-5 relative overflow-hidden rounded-xl border border-brand-200 bg-white shadow-xs dark:border-brand-900/50 dark:bg-dark-800"
            >
              <div
                class="border-b border-brand-100 bg-brand-50/80 px-4 py-3 dark:border-brand-900/40 dark:bg-brand-900/20"
              >
                <div class="flex items-start justify-between gap-3">
                  <div>
                    <div class="flex items-center gap-2">
                      ...
                      <label
                        class="text-sm font-medium text-brand-900 dark:text-brand-100"
                        >{{
                    ...
                    <p
                      class="mt-1 text-xs text-brand-600/90 dark:text-brand-400/90"
                    >
              ...
              <div class="p-4 bg-page/30 dark:bg-dark-800/30">
                <div
                  v-if="createForm.exact_model_mappings.length === 0"
                  class="flex items-center justify-between gap-3 rounded-xl border-2 border-dashed border-brand-200 bg-white px-5 py-4 text-sm text-brand-700 transition-colors hover:border-brand-300 dark:border-brand-900/40 dark:bg-dark-800 dark:text-brand-300 dark:hover:border-brand-800"
                >
                  <span>{{
                  ...
                  <button
                    ...
                    class="flex items-center gap-1.5 text-sm font-medium text-brand-600 transition-colors hover:text-brand-700 dark:text-brand-400 dark:hover:text-brand-300"
                  >
                ...
                <div v-else class="space-y-3">
                  <div
                    ...
                    class="group relative rounded-xl border border-line bg-white p-4 shadow-xs transition-all hover:border-brand-300 hover:shadow-md dark:border-dark-600 dark:bg-dark-700 dark:hover:border-brand-700"
                  >
                    <div class="flex items-center gap-4">
                      ...
                      >
                        <div>
                          ...
                          <input
                            ...
                            "
                            class="input bg-page focus:bg-white dark:bg-dark-800 dark:focus:bg-dark-900"
                          />
                        </div>
                        <div
                          class="hidden md:flex md:justify-center md:pt-7 text-brand-300 dark:text-brand-700"
                        >
                          <Icon
                            name="arrowRight"
                            size="sm"
                      ...
                      <button
                        ...
                        class="mt-6 flex h-9 w-9 items-center justify-center rounded-lg text-ink-faint transition-colors hover:bg-red-50 hover:text-red-500 dark:hover:bg-red-900/20 dark:hover:text-red-400"
                        :title="
                  ...
                  <button
                    type="button"
                    @click="addCreateMessagesDispatchMapping"
 class="flex w-full items-center justify-center gap-2 rounded-xl border-2 border-dashed border-line bg-white py-3 text-sm font-medium text-ink-soft transition-all hover:border-brand-300 hover:bg-brand-50/50 hover:text-brand-600 dark:border-dark-600 dark:bg-dark-800 dark:hover:border-brand-800 dark:hover:bg-brand-900/20 dark:hover:text-brand-400"
                  >
                    <Icon name="plus" size="sm" />
                    {{ t("admin.groups.openaiMessages.addExactMapping") }}
                  </button>
        ...
        <div
          ...
          "
          class="border-t border-line dark:border-dark-400 pt-4 mt-4 space-y-4"
        >
 <h4 class="text-sm font-medium text-ink-body mb-3">
 ...
 <label class="text-sm font-medium text-ink-body">
            ...
            <div class="group relative inline-flex">
              ...
              />
              <div
                class="pointer-events-none absolute bottom-full left-0 z-50 mb-2 w-80 opacity-0 transition-all duration-150 group-hover:pointer-events-auto group-hover:opacity-100"
              >
                <div
                  class="rounded-lg bg-ink p-3 text-white shadow-lg dark:bg-dark-800"
                >
 ...
 class="text-xs text-ink-soft mb-3"
          >
            {{ t("admin.groups.modelRouting.disabledHint") }}
          </p>
 <p v-else class="text-xs text-ink-soft mb-3">
            ...
            >
              <div class="flex items-start gap-3">
                    ...
                    <div class="relative account-search-container">
                      ...
                      >
                        <button
                          ...
                          class="w-full px-3 py-2 text-left text-sm hover:bg-page dark:hover:bg-dark-700"
                          :class="{
                ...
                <button
                  ...
                  class="mt-5 p-1.5 text-ink-faint hover:text-red-500 transition-colors"
          ...
          <button
            ...
            class="mt-3 flex items-center gap-1.5 text-sm text-brand-600 hover:text-brand-700 dark:text-brand-400 dark:hover:text-brand-300"
          >
            <Icon name="plus" size="sm" />
 ...
 class="rounded px-2 py-1 font-medium text-ink-body transition-colors hover:bg-page dark:hover:bg-dark-700"
            ...
            <div
              class="max-h-64 space-y-2 overflow-y-auto p-2"
            >
 <p v-if="editModelsListLoading" class="text-xs text-ink-soft">
                {{ t("admin.groups.modelsList.loading") }}
              </p>
              <p
 ...
 <p class="text-sm text-ink-soft">
        ...
        >
          <div
            ...
            :key="group.id"
            class="flex cursor-grab items-center gap-3 rounded-lg border border-line bg-white p-3 transition-shadow hover:shadow-md active:cursor-grabbing dark:border-dark-600 dark:bg-dark-700"
          >
            <div class="text-ink-faint">
 ...
 <div class="text-xs text-ink-soft">
            ...
            <div class="text-sm text-ink-faint">#{{ group.id }}</div>
          </div>
        </VueDraggable>
      </div>
...
const getQuotaUsageClass = (
  ...
  if (!limit || limit <= 0) {
    return "font-medium text-ink-body dark:text-ink-body";
  }
