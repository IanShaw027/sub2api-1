<template>
  <AppLayout>
    <div class="w-full min-w-0 space-y-6 pb-8">
      <PageHeader
        class="page-header"
        :description="isV1Mode ? t('channelMonitorV2.admin.descriptionV1') : t('channelMonitorV2.admin.descriptionV2')"
      >
        <template #title>
          <span class="page-title">{{ t('admin.channelMonitor.title') }}</span>
        </template>
      </PageHeader>
