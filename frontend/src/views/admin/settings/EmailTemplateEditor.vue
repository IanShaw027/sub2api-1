<template>
  <div class="card">
    <div
      class="flex flex-col gap-3 border-b border-line px-6 py-4 dark:border-dark-700 lg:flex-row lg:items-start lg:justify-between"
    >
      <div>
    ...
    <div class="space-y-6 p-6">
      ...
      <template v-else>
        ...
        <div
          ...
          class="rounded-lg border border-brand-100 bg-brand-50/70 p-4 dark:border-brand-900/50 dark:bg-brand-950/20"
        >
          <div class="flex flex-wrap items-center gap-2">
            <div class="text-sm font-semibold text-ink dark:text-white">
              {{ selectedEventMeta.label }}
            </div>
            <span
              class="rounded-full bg-card px-2.5 py-1 text-xs font-medium text-ink-body shadow-xs ring-1 ring-line dark:bg-dark-800 dark:ring-dark-600"
            >
          ...
          <p class="mt-2 text-sm leading-6 text-ink-body">
        ...
        <div v-else class="grid grid-cols-1 gap-6 xl:grid-cols-2">
            ...
            >
              ...
              <div class="mt-3 flex flex-wrap gap-2">
                <button
                  ...
                  :key="placeholder"
                  type="button"
                  class="rounded-full border border-line bg-card px-3 py-1 font-mono text-xs text-ink-body transition-colors hover:border-brand-300 hover:text-brand-600 dark:border-dark-600 dark:bg-dark-700 dark:hover:border-brand-500 dark:hover:text-brand-300"
          ...
          <div class="space-y-4">
            <div
              class="rounded-lg border border-line bg-card dark:border-dark-700 dark:bg-dark-800"
            >
              <div
              ...
              >
                ...
                <span
                  ...
                  class="rounded-full bg-brand-50 px-2.5 py-1 text-xs font-medium text-brand-700 dark:bg-brand-900/30 dark:text-brand-300"
                >
                  {{ t("admin.settings.emailTemplates.customized") }}
                </span>
              </div>
              <div class="bg-page p-3 dark:bg-dark-900">
                <iframe
                  class="h-[36rem] w-full rounded-md border border-line bg-card dark:border-dark-700"
                  sandbox=""
                  :srcdoc="previewHtml"
