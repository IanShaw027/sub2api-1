        ...
        <div>
          ...
          <div class="mt-1.5 flex items-center justify-between">
            ...
            <router-link
              ...
              to="/forgot-password"
              class="text-sm font-medium text-accent transition-colors hover:text-accent-600 dark:text-accent-300 dark:hover:text-accent-200"
            >
...
async function handleLogin(): Promise<void> {
  ...
  try {
    ...
    const redirectTo = sanitizeRedirectPath(router.currentRoute.value.query.redirect)
