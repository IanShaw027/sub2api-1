<template>
 <AppLayout>
 <div class="airwallex-card mx-auto space-y-6 py-8">
 <div v-if="loading" class="flex items-center justify-center py-20">
 <div class="h-8 w-8 animate-spin rounded-full border-4 border-success border-t-transparent"></div>
 </div>

 <div v-else-if="errorMessage" class="glass-card p-8 text-center">
 ...
 <h3 class="font-semibold text-lg text-foreground">{{ t('payment.airwallexLoadFailed') }}</h3>
 ...
 <div class="h-10 w-10 animate-spin rounded-full border-4 border-success border-t-transparent"></div>
