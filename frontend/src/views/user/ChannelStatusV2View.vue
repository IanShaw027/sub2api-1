<template>
  <AppLayout>
    <div class="space-y-6 pb-12">
      ...
      <section
        class="glass-card sticky top-0 z-20 !rounded-3xl !border-0 p-0 shadow-sm ring-1 ring-[color-mix(in_oklch,var(--foreground)_8%,transparent)]"
      >
      ...
      <div class="relative min-h-[320px]">
        ...
        <div
          v-else-if="loading"
          class="glass-card flex min-h-[320px] items-center justify-center !rounded-3xl !border-0 text-sm text-muted shadow-sm ring-1 ring-[color-mix(in_oklch,var(--foreground)_8%,transparent)]"
        >
          <span class="animate-pulse">{{ t('common.loading') }}</span>
        </div>
      </div>

      <section class="glass-card flex min-h-0 flex-col overflow-hidden !rounded-3xl !border-0 shadow-sm ring-1 ring-[color-mix(in_oklch,var(--foreground)_8%,transparent)]">
