<template>
  <AppLayout>
    <div class="space-y-6">
        ...
        <div class="card card-hover p-4">
          <div class="flex flex-wrap items-center gap-4">
            <div class="flex items-center gap-2">
              <span class="text-sm font-medium text-ink dark:text-ink">{{ t('admin.dashboard.timeRange') }}:</span>
              <DateRangePicker
            ...
            <div class="ml-auto flex items-center gap-2">
              <span class="text-sm font-medium text-ink dark:text-ink">{{ t('admin.dashboard.granularity') }}:</span>
              <div class="w-28">
          ...
          <div class="flex w-full flex-wrap items-center justify-end gap-3 sm:w-auto">
            ...
            <div class="relative" ref="columnDropdownRef">
              ...
              <div
                ...
                class="absolute right-0 top-full z-50 mt-1 max-h-80 w-48 overflow-y-auto rounded-lg border border-line bg-card py-1 shadow-md dark:border-dark-600 dark:bg-dark-800"
              >
                <button
                  ...
                  class="flex w-full items-center justify-between px-4 py-2 text-left text-sm text-ink-body hover:bg-page dark:text-ink-body dark:hover:bg-dark-700"
                >
                  <span>{{ col.label }}</span>
      ...
      <div v-if="errorViewEnabled" class="flex gap-2 border-b border-line dark:border-dark-700">
      ...
      <div v-else-if="errorViewEnabled" class="card overflow-hidden">
