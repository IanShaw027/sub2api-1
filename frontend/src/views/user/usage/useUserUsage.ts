...
/**
 * Extracted state/logic for the user-facing /usage page.
 * Moved out of UsageView.vue (glass-ui-redesign task 12.3) so the view file can
 * stay under the ≤400-line budget; the template & behaviour are unchanged.
 */
export function useUserUsage() {
  ...
  const granularityOptions = computed<SegmentedOption<'day' | 'hour'>[]>(() => [
