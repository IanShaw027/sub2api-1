...
export const useAdminSettingsStore = defineStore('adminSettings', () => {
  ...
  const platformDefaultAccountModelConfig = ref<Record<string, DefaultAccountModelConfig>>({})
  ...
  async function fetch(force = false): Promise<void> {
    ...
    try {
      ...
      platformDefaultAccountModelConfig.value = settings.platform_default_account_model_config || {}
  ...
  return {
    ...
    paymentEnabled,
    customMenuItems,
    platformDefaultAccountModelConfig,
    fetch,
