<template>
 <div
 class="stat-card !min-h-[6.5rem] !rounded-3xl !border-0 !p-4 shadow-sm ring-1 ring-line/5"
 ...
 <span class="stat-label text-[10px] font-bold uppercase tracking-wider text-muted">{{ label }}</span>
 <strong
