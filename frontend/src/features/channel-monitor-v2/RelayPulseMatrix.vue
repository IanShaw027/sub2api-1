<template>
 ...
 <div
 class="matrix-header matrix-row sticky top-0 z-[3] bg-surface-2 text-[10px] font-semibold uppercase tracking-wide text-muted"
 ...
 class="matrix-row border-b border-line/80"
 :class="showThroughput ? 'matrix-row--with-tps' : ''"
 >
 ...
 <strong class="truncate text-xs font-semibold text-foreground">{{ rowLabel(entry.row) }}</strong>
 </div>
 <strong class="summary-value bg-surface text-xs font-medium tabular-nums text-muted">
 {{ successRate(entry.row.metrics) }}
 </strong>
 <strong
 class="summary-value bg-surface text-xs font-medium tabular-nums text-muted"
