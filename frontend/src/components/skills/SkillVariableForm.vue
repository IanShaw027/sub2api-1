<template>
  <div class="space-y-4">
    <div
      ...
      :key="field.key"
      class="rounded-2xl border border-gray-200 bg-white p-4 dark:border-dark-700 dark:bg-dark-900"
    >
      <div class="mb-3">
        <div class="flex items-center gap-2">
          <h3 class="text-sm font-semibold text-gray-900 dark:text-white">{{ field.label }}</h3>
          ...
          <span class="rounded-full bg-gray-100 px-2 py-0.5 text-[11px] text-gray-600 dark:bg-dark-800 dark:text-gray-300">
            {{ field.type }}
          </span>
        </div>
      ...
      <label
        ...
        class="inline-flex items-center gap-3 rounded-xl border border-gray-200 px-4 py-3 text-sm text-gray-700 dark:border-dark-700 dark:text-gray-200"
      >
        <input
    ...
    <div
      ...
      class="rounded-2xl border border-dashed border-gray-200 bg-gray-50 px-4 py-8 text-center text-sm text-gray-500 dark:border-dark-700 dark:bg-dark-900 dark:text-gray-400"
    >
