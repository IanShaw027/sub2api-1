<template>
 ...
 >
 <thead>
 <tr class="border-b border-line bg-surface-2/50 text-xs font-medium uppercase tracking-wide text-muted">
 ...
 <Icon name="inbox" size="xl" class="mx-auto mb-3 h-12 w-12 text-muted" />
 ...
 class="border-b-2 border-line px-4 py-4 last:border-b-0"
 >
 <header class="mb-3 min-w-0">
 <h3 class="break-words text-sm font-semibold text-foreground">
 {{ channel.name }}
 </h3>
 <p class="mt-1 break-words text-xs leading-5 text-muted">
 {{ channel.description || '-' }}
 </p>
 </header>
 ...
 <div class="min-w-0">
 <dt class="mb-1.5 text-[11px] font-medium text-muted">
 {{ columns.groups }}
 </dt>
