<template>
  ...
  <GlassCard v-else variant="glass" padding="sm" class="ui-mini-stat-card">
    <p class="ui-mini-stat-label">{{ label }}</p>
    <p class="ui-mini-stat-value">{{ value }}</p>
    <p v-if="sub" class="ui-mini-stat-sub">{{ sub }}</p>
  </GlassCard>
</template>
