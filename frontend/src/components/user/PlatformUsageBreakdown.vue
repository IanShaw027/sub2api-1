<template>
 ...
 <div
 v-if="hasBreakdown"
 class="pointer-events-none absolute left-full top-0 z-50 ml-2 min-w-[220px] whitespace-nowrap rounded-md bg-surface-3 px-3 py-2 text-xs text-white opacity-0 shadow-glass transition-opacity duration-100 group-hover/usage:opacity-100"
 >
