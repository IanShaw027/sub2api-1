<template>
 ...
 <td class="py-2 pr-3 text-foreground">{{ formatLatency(m.latest_latency_ms) }}</td>
 <td class="py-2 pr-3 text-foreground">{{ formatPercent(m.availability_7d) }}</td>
 <td class="py-2 pr-3 text-foreground">{{ formatPercent(m.availability_15d) }}</td>
 <td class="py-2 pr-3 text-foreground">{{ formatPercent(m.availability_30d) }}</td>
 <td class="py-2 pr-3 text-foreground">{{ formatLatency(m.avg_latency_7d_ms) }}</td>
 </tr>
 </tbody>
 </table>
 </div>
