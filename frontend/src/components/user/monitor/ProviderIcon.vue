<template>
  ...
  <span
    v-else
    class="inline-flex items-center justify-center font-bold text-ink-soft"
...
import { GROK_BRAND_ICON, KIRO_BRAND_ICON } from '@/components/common/platformBrandIcons'
...
const PROVIDER_ICONS: Record<Provider, IconData> = {
  ...
  kiro: {
    viewBox: KIRO_BRAND_ICON.viewBox,
    paths: [KIRO_BRAND_ICON.path],
  },
  grok: {
    viewBox: GROK_BRAND_ICON.viewBox,
    paths: [GROK_BRAND_ICON.path],
  },
}
