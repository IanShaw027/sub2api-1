<template>
 ...
 <div
 class="flex justify-between text-[10px] font-semibold uppercase tracking-widest text-muted mb-2"
 >
 ...
 <div
 v-if="maintenance"
 class="flex h-5 w-full items-center justify-center rounded border border-dashed border-line text-[10px] uppercase tracking-widest text-muted"
 >
 ...
 <div
 class="mt-1 flex justify-between text-[9px] uppercase tracking-widest text-muted"
 >
