<template>
 ...
 class="inline-flex items-center rounded-md px-1.5 py-0.5 text-[10px] font-medium bg-surface-2 text-muted flex-shrink-0"
 >
 {{ item.group_name }}
 </span>
 </div>
 ...
 <!-- Divider -->
 <div class="mt-4 border-t border-line"></div>
