<template>
 ...
 <div class="rounded-lg border border-line p-4 bg-surface">
 ...
 <code class="rounded bg-surface-2 px-3 py-2 font-mono text-sm">
 {{ setupData.secret }}
 </code>
 <button
 type="button"
 class="rounded p-1.5 text-muted hover:bg-surface-2"
 @click="copySecret"
 >
