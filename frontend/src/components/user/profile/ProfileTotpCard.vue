  ...
  <div class="card">
    ...
    <div class="px-6 py-6">
      ...
      <div v-else-if="status && !status.feature_enabled" class="flex items-center gap-4 py-4">
        <div class="flex-shrink-0 rounded-full bg-line p-3 dark:bg-dark-700">
          <svg class="h-6 w-6 text-ink-faint" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
      ...
      <div v-else-if="status?.enabled" class="flex items-center justify-between">
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <p v-if="status.enabled_at" class="text-sm text-ink-soft">
