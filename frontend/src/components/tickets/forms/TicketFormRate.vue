  ...
  <div class="space-y-4">
    <div>
      ...
      <div class="space-y-2 rounded-xl border border-gray-200 p-3 dark:border-dark-700">
        ...
        >
          ...
          <div class="min-w-0 flex-1">
            <div class="flex flex-wrap items-center gap-x-3 gap-y-1">
              ...
              <span v-if="group.user_rate_multiplier != null" class="text-xs text-gray-500 dark:text-gray-400">
        ...
        <p v-if="displayGroups.length === 0" class="text-sm text-gray-500 dark:text-gray-400">
