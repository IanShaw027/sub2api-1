<template>
 ...
 target="_blank"
 rel="noopener noreferrer"
 class="hidden items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-sm font-medium text-muted transition-colors hover:bg-surface-2 hover:text-foreground sm:flex"
 >
 ...
 <div
 v-if="user"
 class="group relative hidden items-center gap-2 rounded-xl bg-[color-mix(in_oklch,var(--accent)_12%,transparent)] px-3 py-1.5 sm:flex"
 >
 <svg
 ...
 <div
 class="pointer-events-none absolute right-0 top-full mt-2 hidden w-56 rounded-lg border border-line bg-surface p-3 text-xs shadow-lg group-hover:block"
 >
 <div class="flex items-center justify-between">
 <span class="text-muted">{{ balanceAvailableText }}</span>
 <span class="font-medium text-foreground">{{ formatHeaderMoney(availableBalance) }}</span>
 </div>
 <div class="mt-2 flex items-center justify-between">
 <span class="text-muted">{{ balanceFrozenText }}</span>
 <span class="font-medium text-amber-700">{{ formatHeaderMoney(frozenBalance) }}</span>
 </div>
 <div class="mt-2 border-t border-line pt-2">
 <div class="flex items-center justify-between">
 <span class="text-muted">{{ balanceTotalText }}</span>
 <span class="font-semibold text-foreground">{{ formatHeaderMoney(totalBalance) }}</span>
 </div>
 </div>
 </div>
 </div>
 ...
 >
 <div class="flex h-8 w-8 items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br from-[var(--accent)] to-[color-mix(in_oklch,var(--accent)_80%,black)] text-sm font-medium text-white shadow-sm">
 <img
 v-if="avatarUrl"
 :src="avatarUrl"
 :alt="displayName"
 ...
 <Icon name="chevronDown" size="sm" class="hidden text-muted md:block" />
 </button>
 ...
 <div
 v-if="contactInfo"
 class="border-t border-line px-4 py-2.5"
 >
