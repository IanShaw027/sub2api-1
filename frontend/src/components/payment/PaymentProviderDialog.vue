<template>
 ...
 <span class="text-xs font-medium text-muted">{{ t('admin.settings.payment.paymentMode') }}</span>
 ...
 <span class="text-xs font-medium text-muted">{{ t('admin.settings.payment.supportedTypes') }}</span>
 ...
 <div v-if="form.provider_key === 'easypay'" class="space-y-3 rounded-lg border border-line p-3">
 ...
 >
 <div>
 <label class="text-xs text-muted">{{ t('admin.settings.payment.customMethodType') }}</label>
 <input v-model="method.type" type="text" class="input mt-0.5" placeholder="credit_card" />
 </div>
 <div>
 <label class="text-xs text-muted">{{ t('admin.settings.payment.customMethodUpstreamType') }}</label>
 <input v-model="method.upstreamType" type="text" class="input mt-0.5" placeholder="credit_card" />
 </div>
 <div>
 <label class="text-xs text-muted">{{ t('admin.settings.payment.customMethodDisplayName') }}</label>
 ...
 <p><span class="text-muted">{{ t('admin.settings.payment.guideOpenLabel') }}</span>{{ item.open }}</p>
 <p><span class="text-muted">{{ t('admin.settings.payment.guideCallLabel') }}</span>{{ item.call }}</p>
 <p><span class="text-muted">{{ t('admin.settings.payment.guideFallbackLabel') }}</span>{{ item.fallback }}</p>
 </div>
 <p v-if="paymentGuide.note" class="border-t border-white/10 pt-2 text-[11px] text-muted">
 {{ paymentGuide.note }}
 </p>
 </div>
 </HelpTooltip>
 ...
 class="absolute inset-y-0 right-0 flex items-center pr-3 text-muted hover:text-muted"
 >
 ...
 />
 <p v-if="field.hintKey" class="mt-1 text-xs leading-relaxed text-muted">
 {{ t(field.hintKey) }}
 </p>
 </div>
 </div>
 ...
 <svg :class="['h-4 w-4 text-muted transition-transform', limitsExpanded && 'rotate-180']" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
 </button>
 ...
 <div>
 <label class="text-xs text-muted">{{ t('admin.settings.payment.limitSingleMin') }}</label>
 <input
 type="number"
 ...
 <div>
 <label class="text-xs text-muted">{{ t('admin.settings.payment.limitSingleMax') }}</label>
 <input
 type="number"
 ...
 <div>
 <label class="text-xs text-muted">{{ t('admin.settings.payment.limitDaily') }}</label>
 <input
 type="number"
