...
describe('PlatformTypeBadge Grok plans', () => {
  ...
  it('keeps SuperGrok labels compatible and marks paid Grok plans', async () => {
    ...
    // Heavy uses the accent plan chip
    expect(wrapper.html()).toContain('bg-accent-100')
  ...
  it('colors free gray, SuperGrok accent, and Heavy accent', async () => {
    ...
    expect(heavy.html()).toContain('bg-accent-100')
