<template>
 ...
 'border-primary-300 bg-primary-50/40': selectable && isRowSelected(row, index)
 }"
 ...
 <thead class="table-header data-table-header">
 <tr>
 <th
 v-if="selectable"
 scope="col"
 ...
 :class="{
 'cursor-pointer': clickableRows,
 'bg-primary-50/40': selectable && isRowSelected(item.row, item.index)
 }"
