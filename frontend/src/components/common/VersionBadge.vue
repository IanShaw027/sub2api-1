<template>
 ...
 @click="handleUpdate"
 :disabled="updating"
 class="flex w-full items-center justify-center gap-2 rounded-lg bg-accent px-4 py-2 text-sm font-medium text-white transition-colors hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
 >
 ...
 target="_blank"
 rel="noopener noreferrer"
 class="flex items-center justify-center gap-1 text-xs text-muted transition-colors hover:text-foreground"
 >
 ...
 target="_blank"
 rel="noopener noreferrer"
 class="flex items-center justify-center gap-2 py-2 text-sm text-muted transition-colors hover:text-foreground"
 >
 ...
 class="group flex w-full items-center justify-between rounded-lg px-2 py-1.5 text-xs text-muted transition-colors hover:bg-surface-2 hover:text-muted"
 >
 ...
 class="w-full rounded-lg border border-line py-1.5 text-xs text-muted transition-colors hover:bg-surface-2 hover:text-foreground"
 >
 {{ t('version.retry') }}
 </button>
 </div>
 ...
 >
 <div
 class="flex items-center justify-between border-b border-line bg-surface-2 px-2 py-1.5"
 >
 <div
 class="flex items-center gap-0.5 rounded-md bg-surface-2/70 p-0.5"
 >
 <button
 ...
 class="flex items-center gap-1 rounded px-1.5 py-0.5 text-[11px] text-muted transition-colors hover:bg-surface-2 hover:text-muted"
 >
 <Icon
 ...
 <code
 class="block select-all whitespace-pre-wrap break-all bg-surface-2 p-2.5 font-mono text-[10px] leading-relaxed text-muted"
