    ...
    <template #footer>
      <div class="flex justify-end space-x-3">
        ...
        <button
          ...
          :disabled="confirming"
          :class="[
            'rounded-md px-4 py-2 text-sm font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-dark-800 disabled:cursor-not-allowed disabled:opacity-50',
            danger
