<template>
 ...
 <Icon v-if="modelValue === PROXY_ROTATION_VALUE" name="check" size="sm" class="text-accent" />
 </div>
 ...
 class="inline-flex flex-shrink-0 items-center rounded bg-surface-2 px-1.5 py-0.5 text-xs text-muted"
 >
 {{ proxy.account_count }}
 </span>
 <!-- Test result badges -->
