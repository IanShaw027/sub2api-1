...
const concurrencyClass = computed(() => {
  ...
  if (current >= max) return 'bg-danger-soft text-danger dark:bg-red-900/30 dark:text-red-400'
  if (current > 0) return 'bg-warning-soft text-warning dark:bg-amber-900/30 dark:text-amber-400'
  return 'bg-page text-ink-soft dark:bg-dark-800 dark:text-dark-400'
})
...
const windowCostClass = computed(() => {
  ...
  if (current >= limit + reserve) return 'bg-danger-soft text-danger dark:bg-red-900/30 dark:text-red-400'
  if (current >= limit) return 'bg-warning-soft text-warning dark:bg-orange-900/30 dark:text-orange-400'
  if (current >= limit * 0.8) return 'bg-warning-soft text-warning dark:bg-amber-900/30 dark:text-amber-400'
  return 'bg-success-soft text-success dark:bg-emerald-900/30 dark:text-emerald-400'
})
...
const sessionLimitClass = computed(() => {
  ...
  if (current >= max) return 'bg-danger-soft text-danger dark:bg-red-900/30 dark:text-red-400'
  if (current >= max * 0.8) return 'bg-warning-soft text-warning dark:bg-amber-900/30 dark:text-amber-400'
  return 'bg-success-soft text-success dark:bg-emerald-900/30 dark:text-emerald-400'
})
...
const rpmClass = computed(() => {
  ...
  if (rpmStrategy.value === 'tiered') {
    if (current >= base + buffer) return 'bg-danger-soft text-danger dark:bg-red-900/30 dark:text-red-400'
    if (current >= base) return 'bg-warning-soft text-warning dark:bg-orange-900/30 dark:text-orange-400'
  } else {
    if (current >= base) return 'bg-warning-soft text-warning dark:bg-orange-900/30 dark:text-orange-400'
  }
  if (current >= base * 0.8) return 'bg-warning-soft text-warning dark:bg-amber-900/30 dark:text-amber-400'
  return 'bg-success-soft text-success dark:bg-emerald-900/30 dark:text-emerald-400'
})
