  ...
  <div v-if="groups && groups.length > 0" class="relative max-w-56">
    ...
    <div class="flex flex-wrap gap-1 max-h-14 overflow-hidden">
      ...
      <button
        ...
        class="inline-flex items-center gap-0.5 rounded-control px-1.5 py-0.5 text-xs font-medium bg-page text-ink-soft hover:bg-line dark:bg-dark-600 dark:text-dark-300 dark:hover:bg-dark-500 transition-colors cursor-pointer whitespace-nowrap"
      >
    ...
    <Teleport to="body">
      ...
      >
        <div
          v-if="showPopover"
          ref="popoverRef"
          class="fixed z-50 min-w-48 max-w-96 rounded-card border border-line bg-card p-3 shadow-md dark:border-dark-600 dark:bg-dark-800"
          :style="popoverStyle"
        >
          <div class="mb-2 flex items-center justify-between">
            ...
            <button
              ...
              class="rounded-control p-0.5 text-ink-faint hover:bg-page hover:text-ink-soft dark:hover:bg-dark-700 dark:hover:text-dark-300"
            >
