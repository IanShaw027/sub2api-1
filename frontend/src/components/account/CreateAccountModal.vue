<template>
  ...
  >
        ...
        <div class="flex items-center">
          <div
            :class="[
              ...
              step >= 1 ? 'bg-brand-500 text-white' : 'bg-page text-ink-soft dark:bg-dark-600'
            ]"
          >
            1
          </div>
          <span class="ml-2 text-sm font-medium text-ink-body">{{
            t('admin.accounts.oauth.authMethod')
          }}</span>
        </div>
        <div class="h-0.5 w-8 bg-line dark:bg-dark-600" />
        <div class="flex items-center">
          <div
            :class="[
              'flex h-8 w-8 items-center justify-center rounded-full text-sm font-semibold',
              step >= 2 ? 'bg-brand-500 text-white' : 'bg-page text-ink-soft dark:bg-dark-600'
            ]"
          >
            2
          </div>
    ...
    >
      ...
      <div>
        ...
        <div class="mt-2 flex flex-wrap rounded-lg bg-page p-1 dark:bg-dark-700" data-tour="account-form-platform">
          <button
            type="button"
            ...
            :class="[
              ...
              form.platform === 'anthropic'
                ? 'bg-card text-orange-600 shadow-xs dark:bg-dark-600 dark:text-orange-400'
                : 'text-ink-body hover:text-ink dark:hover:text-white'
            ]"
          >
          ...
          <button
            ...
            :class="[
              ...
              form.platform === 'openai'
                ? 'bg-card text-green-600 shadow-xs dark:bg-dark-600 dark:text-green-400'
                : 'text-ink-body hover:text-ink dark:hover:text-white'
            ]"
          >
          ...
          <button
            ...
            :class="[
              ...
              form.platform === 'gemini'
                ? 'bg-card text-accent-600 shadow-xs dark:bg-dark-600 dark:text-accent-400'
                : 'text-ink-body hover:text-ink dark:hover:text-white'
            ]"
          >
            <PlatformIcon platform="gemini" size="md" />
            Gemini
          </button>
          <button
            type="button"
            ...
            :class="[
              ...
              form.platform === 'antigravity'
                ? 'bg-card text-purple-600 shadow-xs dark:bg-dark-600 dark:text-purple-400'
                : 'text-ink-body hover:text-ink dark:hover:text-white'
            ]"
          >
            <PlatformIcon platform="antigravity" size="md" />
            Antigravity
          </button>
          <button
            type="button"
            ...
            :class="[
              'flex flex-1 items-center justify-center gap-2 rounded-md px-4 py-2.5 text-sm font-medium transition-all',
              form.platform === 'kiro'
                ? 'bg-card text-cyan-600 shadow-xs dark:bg-dark-600 dark:text-cyan-400'
                : 'text-ink-body hover:text-ink dark:hover:text-white'
            ]"
          >
          ...
          <button
            ...
            :class="[
              'flex flex-1 items-center justify-center gap-2 rounded-md px-4 py-2.5 text-sm font-medium transition-all',
              form.platform === 'grok'
                ? 'bg-card text-zinc-900 shadow-xs dark:bg-dark-600 dark:text-zinc-100'
                : 'text-ink-body hover:text-ink dark:hover:text-white'
            ]"
          >
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-line hover:border-orange-300 dark:border-dark-600 dark:hover:border-orange-700'
            ]"
          >
            <div
              :class="[
                ...
                accountCategory === 'oauth-based'
                  ...
                  : 'bg-page text-ink-soft dark:bg-dark-600'
              ]"
            >
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'apikey'
                ...
                : 'border-line hover:border-purple-300 dark:border-dark-600 dark:hover:border-purple-700'
            ]"
          >
            <div
              :class="[
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'bedrock'
                ...
                : 'border-line hover:border-amber-300 dark:border-dark-600 dark:hover:border-amber-700'
            ]"
          >
            <div
              :class="[
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'service_account'
                ...
                : 'border-line hover:border-sky-300 dark:border-dark-600 dark:hover:border-sky-700'
            ]"
          >
            <div
              :class="[
            ...
            <div>
              <span class="block text-sm font-medium text-ink dark:text-white">{{ t('admin.accounts.vertexLabel') }}</span>
              <span class="text-xs text-ink-soft">{{ t('admin.accounts.vertexDesc') }}</span>
            </div>
          </button>
      ...
      <div v-if="form.platform === 'openai'">
        ...
        <div class="mt-2 grid grid-cols-2 gap-3" data-tour="account-form-type">
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-line hover:border-green-300 dark:border-dark-600 dark:hover:border-green-700'
            ]"
          >
            <div
              :class="[
            ...
            <div>
              <span class="block text-sm font-medium text-ink dark:text-white">{{ t('admin.accounts.types.oauth') }}</span>
              <span class="text-xs text-ink-soft">{{ t('admin.accounts.types.chatgptOauth') }}</span>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-ink dark:text-white">{{ t('admin.accounts.apiKey') }}</span>
              <span class="text-xs text-ink-soft">{{ t('admin.accounts.types.responsesApi') }}</span>
            </div>
          </button>
      ...
      <!-- Account Type Selection (Grok - OAuth subscription or xAI API key) -->
      <div v-if="form.platform === 'grok'">
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-line hover:border-zinc-400 dark:border-dark-600 dark:hover:border-zinc-600'
            ]"
          >
            <div
              :class="[
            ...
            <div>
              <span class="block text-sm font-medium text-ink dark:text-white">OAuth</span>
              <span class="text-xs text-ink-soft">{{ t('admin.accounts.types.grokOauth') }}</span>
            </div>
          </button>
          <button
            type="button"
        ...
        <p v-if="accountCategory === 'oauth-based'" class="mt-2 text-xs text-ink-soft">
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-line hover:border-accent-300 dark:border-dark-600 dark:hover:border-accent-700'
            ]"
          >
            <div
              :class="[
        ...
        <div v-if="accountCategory === 'oauth-based'" class="mt-4">
          ...
          <div class="mt-2 grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div class="min-w-0">
                <span class="block text-sm font-medium text-ink dark:text-white">
                  {{ t('admin.accounts.oauth.gemini.codeAssistTitle') }}
                </span>
                <span class="text-xs text-ink-soft">
                  {{ t('admin.accounts.oauth.gemini.codeAssistDesc') }}
                </span>
                <div class="mt-1 text-xs text-ink-soft">
                  {{ t('admin.accounts.oauth.gemini.codeAssistRequirement') }}
                  <a
      ...
      <div v-if="form.platform === 'antigravity'">
        ...
        <div class="mt-2 grid grid-cols-2 gap-3" data-tour="account-form-type">
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-ink dark:text-white">{{ t('admin.accounts.types.oauth') }}</span>
              <span class="text-xs text-ink-soft">{{ t('admin.accounts.types.antigravityOauth') }}</span>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-ink dark:text-white">{{ t('admin.accounts.apiKey') }}</span>
              <span class="text-xs text-ink-soft">{{ t('admin.accounts.types.antigravityApikey') }}</span>
            </div>
          </button>
        </div>
      </div>
          ...
          <button
            ...
            :class="[
              ...
              kiroAccountType === 'oauth'
                ...
                : 'border-line hover:border-cyan-300 dark:border-dark-600 dark:hover:border-cyan-700'
            ]"
          >
            <div
              :class="[
      ...
      <div v-if="form.platform === 'kiro'" class="border-t border-line pt-4 dark:border-dark-600">
          ...
          <button
            ...
            :class="[
              ...
              modelRestrictionMode === 'whitelist'
                ...
                : 'bg-page text-ink-body hover:bg-line dark:bg-dark-600 dark:hover:bg-dark-500'
            ]"
          >
        ...
        <div v-else>
          ...
          <div v-if="modelMappings.length > 0" class="mb-3 space-y-2">
            ...
            >
              ...
              />
              <svg
                class="h-4 w-4 flex-shrink-0 text-ink-faint"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
          ...
          <div v-else class="mb-3 rounded-lg border border-dashed border-line p-4 text-center dark:border-dark-500">
          ...
          <div class="flex flex-wrap gap-2">
            <button
              ...
              class="rounded-lg border border-line px-3 py-2 text-sm font-medium text-ink-body transition-colors hover:bg-page dark:border-dark-500 dark:hover:bg-dark-700"
            >
        ...
        <div>
          ...
          <div
            :class="[
              ...
              vertexServiceAccountDragActive
                ...
                : 'border-line bg-page hover:border-sky-400 hover:bg-sky-50/60 dark:border-dark-500 dark:bg-dark-700/40 dark:hover:border-sky-600 dark:hover:bg-sky-900/10'
            ]"
          ...
          >
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div class="min-w-0">
                <div class="flex items-center gap-2 text-sm font-medium text-ink dark:text-white">
            ...
            <div
              ...
              class="mt-3 rounded-md border border-sky-200 bg-card px-3 py-2 text-xs text-sky-900 dark:border-sky-800/50 dark:bg-dark-800 dark:text-sky-200"
            >
      ...
      <div v-if="form.platform === 'antigravity'" class="border-t border-line pt-4 dark:border-dark-600">
        <label class="input-label">{{ t('admin.accounts.modelRestriction') }}</label>
        ...
        <div>
            ...
            >
              <div class="flex items-center gap-2">
                <input
                  ...
                  :placeholder="t('admin.accounts.requestModel')"
                />
                <svg class="h-4 w-4 flex-shrink-0 text-ink-faint" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <button
            ...
            class="mb-3 w-full rounded-lg border-2 border-dashed border-line px-4 py-2 text-ink-body transition-colors hover:border-ink-faint hover:text-ink-body dark:border-dark-500 dark:hover:border-dark-400 dark:hover:text-ink-faint"
          >
      ...
      <div v-if="form.platform === 'anthropic' && isOAuthFlow">
        ...
        <div class="mt-2 flex gap-4">
          <label class="flex cursor-pointer items-center">
            ...
            />
            <span class="text-sm text-ink-body">{{ t('admin.accounts.types.oauth') }}</span>
          </label>
          <label class="flex cursor-pointer items-center">
            <input
              v-model="addMethod"
          ...
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                ...
                poolModeEnabled ? 'bg-brand-600' : 'bg-line dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
        ...
        <div class="border-t border-line pt-4 dark:border-dark-600">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent/25 focus:ring-offset-2',
                customErrorCodesEnabled ? 'bg-brand-600' : 'bg-line dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="customErrorCodesEnabled" class="space-y-3">
            ...
            <div class="flex flex-wrap gap-1.5">
              ...
              <span v-if="selectedErrorCodes.length === 0" class="text-xs text-ink-faint">
          ...
          <div class="mt-2 flex gap-4">
            <label class="flex cursor-pointer items-center">
              <input
                ...
                class="mr-2 text-brand-600 focus:ring-accent/25"
              />
              <span class="text-sm text-ink-body">{{ t('admin.accounts.bedrockAuthModeSigv4') }}</span>
            </label>
            <label class="flex cursor-pointer items-center">
              <input
                v-model="bedrockAuthMode"
                ...
                class="mr-2 text-brand-600 focus:ring-accent/25"
              />
              <span class="text-sm text-ink-body">{{ t('admin.accounts.bedrockAuthModeApikey') }}</span>
            </label>
          </div>
        </div>
        ...
        <div>
          <label class="flex items-center gap-2 cursor-pointer">
            <input
              ...
              type="checkbox"
              class="rounded border-line text-brand-600 focus:ring-accent/25 dark:border-dark-500"
            />
            <span class="text-sm text-ink-body">{{ t('admin.accounts.bedrockForceGlobal') }}</span>
          </label>
      ...
      <div
        ...
        class="border-t border-line pt-4 dark:border-dark-600 space-y-4"
      >
        <div class="mb-3">
      ...
      <div
        ...
        class="border-t border-line pt-4 dark:border-dark-600"
      >
        <label class="input-label">{{ t('admin.accounts.modelRestriction') }}</label>
      ...
      <div class="border-t border-line pt-4 dark:border-dark-600 space-y-4">
        <div class="mb-3 flex items-center justify-between">
          <div>
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent/25 focus:ring-offset-2',
              tempUnschedEnabled ? 'bg-brand-600' : 'bg-line dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
        ...
        <div v-if="tempUnschedEnabled" class="space-y-3">
          ...
          <div class="flex flex-wrap gap-2">
            <button
              ...
              class="rounded-lg bg-page px-3 py-1.5 text-xs font-medium text-ink-body transition-colors hover:bg-line dark:bg-dark-600 dark:hover:bg-dark-500"
            >
              + {{ preset.label }}
            </button>
          </div>
          ...
          <div v-if="tempUnschedRules.length > 0" class="space-y-3">
            <div
              ...
              class="rounded-lg border border-line p-3 dark:border-dark-600"
            >
              <div class="mb-2 flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                  <button
                    ...
                    class="rounded p-1 text-ink-faint transition-colors hover:text-ink-body disabled:cursor-not-allowed disabled:opacity-40 dark:hover:text-white"
                  >
          ...
          <button
            ...
            class="w-full rounded-lg border-2 border-dashed border-line px-4 py-2 text-sm text-ink-body transition-colors hover:border-ink-faint hover:text-ink-body dark:border-dark-500 dark:hover:border-dark-400 dark:hover:text-ink-faint"
          >
            <svg
              class="mr-1 inline h-4 w-4"
              fill="none"
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent/25 focus:ring-offset-2',
              interceptWarmupRequests ? 'bg-brand-600' : 'bg-line dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
      ...
      >
        ...
        <!-- Window Cost Limit -->
        <div class="rounded-lg border border-line p-4 dark:border-dark-600">
          <div class="mb-3 flex items-center justify-between">
            <div>
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent/25 focus:ring-offset-2',
                windowCostEnabled ? 'bg-brand-600' : 'bg-line dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="windowCostEnabled" class="grid grid-cols-2 gap-4">
            <div>
              ...
              <div class="relative">
                <span class="absolute left-3 top-1/2 -translate-y-1/2 text-ink-soft">$</span>
                <input
        ...
        <div class="rounded-lg border border-line p-4 dark:border-dark-600">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent/25 focus:ring-offset-2',
                sessionLimitEnabled ? 'bg-brand-600' : 'bg-line dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="sessionLimitEnabled" class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div class="relative">
                ...
                />
                <span class="absolute right-3 top-1/2 -translate-y-1/2 text-ink-soft">{{ t('common.minutes') }}</span>
              </div>
        ...
        <div class="rounded-lg border border-line p-4 dark:border-dark-600">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent/25 focus:ring-offset-2',
                rpmLimitEnabled ? 'bg-brand-600' : 'bg-line dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
          ...
          <div class="mt-4">
            ...
            <p class="mt-1 text-xs text-ink-soft mb-2">
              ...
              <button type="button" v-for="opt in umqModeOptions" :key="opt.value"
                ...
                :class="[
                  ...
                  userMsgQueueMode === opt.value
                    ...
                    : 'bg-card dark:bg-dark-700 text-ink-body border-line dark:border-dark-500 hover:bg-page dark:hover:bg-dark-600'
                ]">
                {{ opt.label }}
              </button>
            </div>
        ...
        <div class="rounded-lg border border-line p-4 dark:border-dark-600">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent/25 focus:ring-offset-2',
                tlsFingerprintEnabled ? 'bg-brand-600' : 'bg-line dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="tlsFingerprintEnabled" class="mt-3">
            ...
            <div class="mt-3 border-t border-divider pt-3 dark:border-dark-700">
        ...
        <div class="rounded-lg border border-line p-4 dark:border-dark-600">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent/25 focus:ring-offset-2',
                sessionIdMaskingEnabled ? 'bg-brand-600' : 'bg-line dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-line p-4 dark:border-dark-600">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent/25 focus:ring-offset-2',
                cacheTTLOverrideEnabled ? 'bg-brand-600' : 'bg-line dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="cacheTTLOverrideEnabled" class="mt-3">
            ...
            <select
              ...
              class="mt-1 block w-full rounded-md border border-line bg-card px-3 py-2 text-sm shadow-xs focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent/25 dark:border-dark-500 dark:bg-dark-700 dark:text-white"
            >
        ...
        <div class="rounded-lg border border-line p-4 dark:border-dark-600">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent/25 focus:ring-offset-2',
                customBaseUrlEnabled ? 'bg-brand-600' : 'bg-line dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent/25 focus:ring-offset-2',
              openaiPassthroughEnabled ? 'bg-brand-600' : 'bg-line dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent/25 focus:ring-offset-2',
              openaiImageGenerationEnabled ? 'bg-brand-600' : 'bg-line dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
      ...
      >
        ...
        <div v-if="tlsFingerprintEnabled" class="mt-3">
          ...
          <div v-if="form.platform === 'openai'" class="mt-3 border-t border-divider pt-3 dark:border-dark-700">
            <TLSFingerprintBindingMatrix
              v-model="tlsFingerprintBindings"
              :profiles="tlsFingerprintProfiles"
              platform="openai"
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent/25 focus:ring-offset-2',
              anthropicPassthroughEnabled ? 'bg-brand-600' : 'bg-line dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
      ...
      >
        <div class="flex items-center justify-between gap-4">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent/25 focus:ring-offset-2',
              openAILongContextBillingEnabled ? 'bg-brand-600' : 'bg-line dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent/25 focus:ring-offset-2',
              codexCLIOnlyEnabled ? 'bg-brand-600' : 'bg-line dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
        ...
        <div
          ...
          class="mt-4 flex items-center justify-between border-l-2 border-line pl-4 dark:border-dark-600"
        >
          <div>
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent/25 focus:ring-offset-2',
              codexCLIOnlyAppServerEnabled ? 'bg-brand-600' : 'bg-line dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
      ...
      >
        ...
        <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
          <label
            ...
            :key="option.value"
            class="flex cursor-pointer items-center gap-2 rounded-lg border border-line px-3 py-2 text-sm dark:border-dark-600"
          >
            <input
              type="checkbox"
              class="rounded border-line text-brand-600 focus:ring-accent/25 dark:border-dark-500"
            ...
            />
            <span class="text-ink-body dark:text-white">{{ option.label }}</span>
          </label>
        </div>
        <p class="input-hint">{{ t('admin.accounts.openai.endpointCapabilitiesDesc') }}</p>
      </div>

      <div v-if="showTextEndpointAutoRoute" class="border-t border-line pt-4 dark:border-dark-600">
        <div class="flex items-center justify-between">
          <div>
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent/25 focus:ring-offset-2',
              textEndpointAutoRouteEnabled ? 'bg-brand-600' : 'bg-line dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
      ...
      <div>
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-accent/25 focus:ring-offset-2',
              autoPauseOnExpired ? 'bg-brand-600' : 'bg-line dark:bg-dark-600'
            ]"
          >
            <span
              :class="[
        ...
        <div v-if="form.platform === 'antigravity'" class="flex items-center gap-2">
          <label class="flex cursor-pointer items-center gap-2">
            <input
              ...
              class="h-4 w-4 rounded border-line text-brand-500 focus:ring-accent/25 dark:border-dark-500"
            />
          ...
          <div class="group relative">
            <span
              class="inline-flex h-4 w-4 cursor-help items-center justify-center rounded-full bg-line text-xs text-ink-soft hover:bg-divider dark:bg-dark-600 dark:hover:bg-dark-500"
            >
              ?
            </span>
            <!-- Tooltip（向下显示避免被弹窗裁剪） -->
            <div
              class="pointer-events-none absolute left-0 top-full z-[100] mt-1.5 w-72 rounded bg-ink px-3 py-2 text-xs text-white opacity-0 transition-opacity group-hover:opacity-100 dark:bg-dark-700"
            >
              {{ t('admin.accounts.mixedSchedulingTooltip') }}
              <div
                class="absolute bottom-full left-3 border-4 border-transparent border-b-ink dark:border-b-dark-600"
              ></div>
            </div>
          </div>
        </div>
  ...
  >
    <div class="space-y-6">
      <!-- Setup Guide Section -->
      <div>
        <h3 class="mb-3 text-sm font-semibold text-ink dark:text-white">
          {{ t('admin.accounts.gemini.setupGuide.title') }}
        </h3>
        <div class="space-y-4">
          <div>
            <p class="mb-2 text-sm font-medium text-ink-body">
              {{ t('admin.accounts.gemini.setupGuide.checklistTitle') }}
            </p>
            <ul class="list-inside list-disc space-y-1 text-sm text-ink-body">
      ...
      <div class="border-t border-line pt-6 dark:border-dark-600">
        <h3 class="mb-3 text-sm font-semibold text-ink dark:text-white">
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-xs">
            <thead class="bg-page dark:bg-dark-600">
              <tr>
                <th class="px-3 py-2 text-left font-medium text-ink-body">
            ...
            <tbody class="divide-y divide-line dark:divide-dark-600">
              <tr>
                <td class="px-3 py-2 text-ink dark:text-white">
                  {{ t('admin.accounts.gemini.quotaPolicy.rows.googleOne.channel') }}
                </td>
                <td class="px-3 py-2 text-ink-body">{{ t('admin.accounts.gemini.tier.googleOne.free') }}</td>
                <td class="px-3 py-2 text-ink-body">
                  {{ t('admin.accounts.gemini.quotaPolicy.rows.googleOne.limitsFree') }}
                </td>
              </tr>
              <tr>
                <td class="px-3 py-2 text-ink dark:text-white"></td>
                <td class="px-3 py-2 text-ink-body">{{ t('admin.accounts.gemini.tier.googleOne.pro') }}</td>
                <td class="px-3 py-2 text-ink-body">
              ...
              <tr>
                <td class="px-3 py-2 text-ink dark:text-white"></td>
                <td class="px-3 py-2 text-ink-body">{{ t('admin.accounts.gemini.tier.googleOne.ultra') }}</td>
                <td class="px-3 py-2 text-ink-body">
              ...
              <tr>
                ...
                <td class="px-3 py-2 text-ink-body">{{ t('admin.accounts.gemini.tier.gcp.standard') }}</td>
                <td class="px-3 py-2 text-ink-body">
              ...
              <tr>
                <td class="px-3 py-2 text-ink dark:text-white"></td>
                <td class="px-3 py-2 text-ink-body">{{ t('admin.accounts.gemini.tier.gcp.enterprise') }}</td>
                <td class="px-3 py-2 text-ink-body">
              ...
              <tr>
                ...
                <td class="px-3 py-2 text-ink-body">{{ t('admin.accounts.gemini.tier.aiStudio.free') }}</td>
                <td class="px-3 py-2 text-ink-body">
              ...
              <tr>
                <td class="px-3 py-2 text-ink dark:text-white"></td>
                <td class="px-3 py-2 text-ink-body">{{ t('admin.accounts.gemini.tier.aiStudio.paid') }}</td>
                <td class="px-3 py-2 text-ink-body">
...
const getResponseRewriteRuleKey = createStableObjectKeyResolver<ResponseRewriteRuleForm>('create-response-rewrite-rule')
...
const createAccountAndFinish = async (
  ...
  if (!applyCredentialRuleConfigs(credentials, platform)) {
    return
  }
...
const handleOpenAIExchange = async (authCode: string) => {
  ...
  try {
    ...
    // 应用账号级错误规则配置
    if (!applyCredentialRuleConfigs(credentials, 'openai')) {
      return
    }
...
const handleOpenAIImportCodexSession = async (content: string) => {
  ...
  try {
    const extra = buildTextEndpointAutoRouteExtra('openai', 'oauth', buildOpenAICodexImportExtra())
