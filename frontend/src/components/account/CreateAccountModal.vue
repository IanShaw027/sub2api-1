        ...
        <div v-if="accountCategory === 'oauth-based'" class="mt-4">
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  ...
                  >
                    {{ t('admin.accounts.gemini.oauthType.noGcpNeeded') }}
                  </span>
                </div>
              </div>
            </button>
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.accounts.gemini.oauthType.codeAssistHint') }}
                  <a
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  ...
                  >
                    {{ t('admin.accounts.gemini.oauthType.enterpriseUser') }}
                  </span>
                  <span
                    class="rounded bg-emerald-100 px-2 py-0.5 text-[10px] font-semibold text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300"
                  >
                    {{ t('admin.accounts.gemini.oauthType.highConcurrency') }}
                  </span>
                </div>
              </div>
            </button>
          ...
          <div class="mt-3">
            ...
            >
              ...
              <span>{{ showAdvancedOAuth ? t('admin.accounts.oauth.gemini.hideAdvancedOptions') : t('admin.accounts.oauth.gemini.showAdvancedOptions') }}</span>
            </button>
          </div>
