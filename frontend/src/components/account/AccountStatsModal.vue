<template>
  ...
  >
    <div class="space-y-6">
      ...
      >
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <div class="text-xs text-ink-soft dark:text-ink-soft">
      ...
      <template v-else-if="stats">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="rounded-control bg-success-soft p-1.5 dark:bg-success/15">
                <svg
          ...
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="rounded-control bg-accent-100 p-1.5 dark:bg-accent-900/30">
          ...
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="rounded-control bg-warning-soft p-1.5 dark:bg-warning/15">
                <Icon
                  name="calculator"
                  size="sm"
          ...
          <div
            class="card border-brand/25 bg-gradient-to-br from-brand-50 to-card p-4 dark:border-brand/30 dark:from-brand/10 dark:to-dark-700"
          >
            <div class="mb-2 flex items-center justify-between">
              <span class="text-xs font-medium text-ink-soft dark:text-ink-soft">{{
                t('admin.accounts.stats.avgDailyRequests')
              }}</span>
              <div class="rounded-control bg-brand-100 p-1.5 dark:bg-brand-900/30">
                <svg
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-control bg-brand-100 p-1.5 dark:bg-brand-900/30">
                <svg
                  class="h-4 w-4 text-brand-600 dark:text-brand-cyan"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                <span class="text-xs text-ink-soft dark:text-ink-soft">{{ t('usage.accountBilled') }}</span>
                <span class="text-sm font-semibold text-ink dark:text-white"
                  >${{ formatCost(stats.summary.today?.cost || 0) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-ink-soft dark:text-ink-soft">{{ t('usage.userBilled') }}</span>
                <span class="text-sm font-semibold text-ink dark:text-white"
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-control bg-brand-100 p-1.5 dark:bg-brand-900/30">
                <Icon name="cube" size="sm" class="text-brand-600 dark:text-brand-400" :stroke-width="2" />
              </div>
              <span class="text-sm font-semibold text-ink dark:text-white">{{
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-control bg-danger-soft p-1.5 dark:bg-danger/15">
                <Icon name="bolt" size="sm" class="text-danger dark:text-danger" :stroke-width="2" />
              </div>
              <span class="text-sm font-semibold text-ink dark:text-white">{{
        ...
        <div class="card p-4">
          ...
          <div class="h-64">
            ...
            <div
              v-else
              class="flex h-full items-center justify-center text-sm text-ink-soft dark:text-ink-soft"
            >
      ...
      <div
        v-else-if="!loading"
        class="flex flex-col items-center justify-center py-12 text-ink-soft dark:text-ink-soft"
      >
