    ...
    >
      ...
      <div v-if="account.type === 'apikey'" class="space-y-4">
        ...
        <div>
          ...
          <!-- Gemini API Key 获取链接 -->
          <div v-if="account.platform === 'gemini'" class="mt-2">
            <a
              href="https://aistudio.google.com/app/apikey"
              target="_blank"
              rel="noopener noreferrer"
              class="inline-flex items-center text-sm font-medium text-blue-600 underline-offset-4 hover:underline dark:text-blue-400"
            >
