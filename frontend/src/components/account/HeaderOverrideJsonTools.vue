<template>
  <button
    type="button"
    class="rounded-lg bg-[color-mix(in_oklch,var(--accent)_12%,transparent)] px-3 py-1 text-xs text-accent transition-colors hover:bg-[color-mix(in_oklch,var(--accent)_12%,transparent)]"
  ...
  <button
    type="button"
    class="rounded-lg bg-[color-mix(in_oklch,var(--accent)_12%,transparent)] px-3 py-1 text-xs text-accent transition-colors hover:bg-[color-mix(in_oklch,var(--accent)_12%,transparent)] disabled:cursor-not-allowed disabled:opacity-50"
  ...
  <div v-if="showImportPanel" ref="importPanelRef" class="w-full space-y-2">
    ...
    <div class="flex gap-2">
      <button
        type="button"
        class="rounded-lg bg-accent px-3 py-1 text-xs text-white transition-colors hover:opacity-90"
        @click="applyImport"
      >
      ...
      <button
        type="button"
        class="rounded-lg bg-surface-2 px-3 py-1 text-xs text-muted transition-colors hover:bg-surface-3"
