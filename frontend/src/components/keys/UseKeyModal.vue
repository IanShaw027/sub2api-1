<template>
 ...
 <!-- Client Tabs -->
 <div v-if="clientTabs.length" class="overflow-x-auto border-b border-line">
 ...
 <div
 class="grid grid-cols-2 gap-1 rounded-lg bg-surface-2 p-1"
 role="radiogroup"
 ...
 class="mt-3 flex items-start gap-2 border-l-2 border-warning-400 bg-warning-50 px-3 py-2 text-xs leading-5 text-warning-800"
 >
 ...
 <!-- OS/Shell Tabs -->
 <div v-if="showShellTabs" class="overflow-x-auto border-b border-line">
