<template>
  <Modal :show="show" :title="t('keys.useKeyModal.title')" size="lg" @close="emit('close')">
    <div class="space-y-4">
      <!-- Description -->
      ...
      <div class="relative">
        <div class="overflow-hidden rounded-xl bg-gray-900 dark:bg-dark-900">
          ...
          >
            <span class="font-mono text-xs text-gray-400">{{ activeTabConfig?.filename }}</span>
            <button
              @click="copyConfig"
          ...
          <!-- Code Content -->
          <pre
            class="overflow-x-auto p-4 font-mono text-sm text-gray-100"
