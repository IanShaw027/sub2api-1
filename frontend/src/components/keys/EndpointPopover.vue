...
<template>
 ...
 <div
 class="pointer-events-none absolute bottom-full left-1/2 z-20 mb-2 w-max max-w-[24rem] -translate-x-1/2 translate-y-1 rounded-xl border border-slate-200 bg-surface px-3 py-2.5 text-left opacity-0 shadow-[0_14px_36px_-20px_rgba(15,23,42,0.35)] ring-1 ring-slate-200/80 transition-all duration-150 group-hover/endpoint:translate-y-0 group-hover/endpoint:opacity-100 group-focus-within/endpoint:translate-y-0 group-focus-within/endpoint:opacity-100"
 >
 <p
 ...
 <code
 class="cursor-pointer font-mono text-muted decoration-gray-400 decoration-dashed underline-offset-2 hover:text-accent hover:underline focus:text-accent focus:underline focus:outline-none"
 role="button"
 tabindex="0"
 ...
 class="rounded p-0.5 text-muted transition-colors hover:text-amber-500"
