  ...
  <div class="space-y-4">
    ...
    <div>
      ...
      <div class="space-y-1.5">
        ...
        >
          ...
          <button
            type="button"
            class="flex-none rounded p-1 text-ink-faint hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-500/10 dark:hover:text-red-400"
        ...
        <button
          type="button"
          class="inline-flex items-center gap-1 rounded border border-dashed border-line px-2 py-1 text-xs text-ink-soft hover:border-brand-400 hover:text-brand-600 dark:border-dark-600 dark:hover:border-brand-500 dark:hover:text-brand-400"
          @click="addRow"
        >
    ...
    <div v-if="bodyOverrideMode !== 'off'">
      <div class="mb-1 flex items-center justify-between">
        ...
        <button
          type="button"
          class="text-xs text-brand-600 hover:underline disabled:cursor-not-allowed disabled:text-ink-faint disabled:no-underline dark:text-brand-400"
...
function bodyModeButtonClass(mode: BodyOverrideMode): string {
  ...
  if (active) {
    return 'border-brand-500 bg-brand-50 text-brand-700 dark:bg-brand-500/15 dark:text-brand-300 dark:border-brand-400'
  }
  return 'border-line bg-card text-ink-body hover:border-brand-300 dark:border-dark-700 dark:bg-dark-800'
}
