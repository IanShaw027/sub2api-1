  ...
  <div class="space-y-4">
    ...
    <div>
      ...
      <div class="space-y-1.5">
        ...
        >
          ...
          <button
            type="button"
            class="flex-none rounded p-1 text-muted hover:bg-[color-mix(in_oklch,var(--danger)_14%,transparent)] hover:text-danger-text"
        ...
        <button
          type="button"
          class="inline-flex items-center gap-1 rounded border border-dashed border-line px-2 py-1 text-xs text-muted hover:border-accent hover:text-accent"
          @click="addRow"
        >
    ...
    <div v-if="bodyOverrideMode !== 'off'">
      <div class="mb-1 flex items-center justify-between">
        ...
        <button
          type="button"
          class="text-xs text-accent hover:underline disabled:cursor-not-allowed disabled:text-muted disabled:no-underline"
...
function bodyModeButtonClass(mode: BodyOverrideMode): string {
  ...
  if (active) {
    return 'border-accent bg-[color-mix(in_oklch,var(--accent)_12%,transparent)] text-accent'
  }
  return 'border-line bg-surface text-muted hover:border-[color-mix(in_oklch,var(--accent)_28%,transparent)]'
}
