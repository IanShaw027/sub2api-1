  ...
  >
    <form id="channel-monitor-form" @submit.prevent="handleSubmit" class="space-y-5">
      ...
      <div
        ...
        class="rounded-lg border border-accent-100 bg-accent-50/50 p-3 dark:border-blue-500/20 dark:bg-blue-500/10"
      >
      ...
      <div>
        ...
        <p v-if="editing && editing.api_key_masked" class="mt-1 text-xs text-ink-faint">{{ editing.api_key_masked }}</p>
      </div>
      ...
      <div>
        ...
        <p class="mt-1 text-xs text-ink-faint">{{ t('admin.channelMonitor.form.intervalSecondsHint') }}</p>
      </div>
      ...
      <div>
        ...
        <p class="mt-1 text-xs text-ink-faint">{{ t('admin.channelMonitor.form.jitterSecondsHint') }}</p>
      </div>
      ...
      <details class="rounded-lg border border-line bg-page/50 p-3 dark:border-dark-700 dark:bg-dark-900/30">
        <summary class="cursor-pointer text-sm font-medium text-ink-body dark:text-ink-body">
          {{ t('admin.channelMonitor.advanced.section') }}
        </summary>
        <p class="mt-1 text-xs text-ink-faint">{{ t('admin.channelMonitor.advanced.sectionHint') }}</p>
        ...
        <div class="mt-4 space-y-4">
          <div>
            ...
            />
            <p class="mt-1 text-xs text-ink-faint">{{ t('admin.channelMonitor.templateField.applyHint') }}</p>
          </div>
