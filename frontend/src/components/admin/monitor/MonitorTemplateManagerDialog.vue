<template>
  ...
  >
    ...
    <div v-else class="space-y-4">
      ...
      <div v-if="form.provider === PROVIDER_OPENAI" class="rounded-lg border border-[color-mix(in_oklch,var(--accent)_12%,transparent)] bg-[color-mix(in_oklch,var(--accent)_6%,transparent)] p-3">
