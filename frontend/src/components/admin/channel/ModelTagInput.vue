<template>
  <div>
    <!-- Tags display -->
    <div class="flex flex-wrap gap-1.5 rounded-lg border border-line bg-card p-2 dark:border-dark-600 dark:bg-dark-800 min-h-[2.5rem]">
      <span
      ...
      >
        ...
        <button
          ...
          class="ml-0.5 rounded-full p-0.5 hover:bg-brand-200 dark:hover:bg-brand-800"
        >
          <Icon name="x" size="xs" />
        </button>
      </span>
      <input
        ...
        v-model="inputValue"
        type="text"
        class="flex-1 min-w-[120px] border-none bg-transparent text-sm outline-none placeholder:text-ink-faint dark:text-white"
