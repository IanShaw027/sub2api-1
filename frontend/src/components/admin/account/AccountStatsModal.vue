        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="rounded-lg bg-[color-mix(in_oklch,var(--success)_16%,transparent)] p-1.5">
                <Icon name="dollar" size="sm" class="text-success-text" />
              </div>
            </div>
          ...
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="rounded-lg bg-[color-mix(in_oklch,var(--accent)_12%,transparent)] p-1.5">
                <Icon name="bolt" size="sm" class="text-accent" />
              </div>
            </div>
            <p class="text-2xl font-bold text-foreground">
          ...
          <div class="glass-card p-4">
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                <span class="text-xs text-muted">{{ t('usage.accountBilled') }}</span>
                <span class="text-sm font-semibold text-foreground"
                  >${{ formatCost(stats.summary.today?.cost || 0) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-muted">{{ t('usage.userBilled') }}</span>
                <span class="text-sm font-semibold text-foreground"
          ...
          <div class="glass-card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-[color-mix(in_oklch,var(--warning)_18%,transparent)] p-1.5">
                <Icon name="fire" size="sm" class="text-warning-text" />
              </div>
              <span class="text-sm font-semibold text-foreground">{{
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center justify-between">
                <span class="text-xs text-muted">{{ t('usage.accountBilled') }}</span>
                <span class="text-sm font-semibold text-warning-text"
