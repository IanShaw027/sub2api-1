 ...
 : 'border-line bg-surface hover:border-line'"
            >
              <div class="flex items-center gap-4">
                ...
                <div class="flex-shrink-0">
                  <label class="relative flex h-6 w-6 cursor-pointer items-center justify-center">
                    <input
                      ...
                      class="peer sr-only"
                    />
                    <div class="h-5 w-5 rounded-md border-2 border-line transition-all peer-checked:border-accent peer-checked:bg-accent peer-checked:">
                ...
                <div class="min-w-0 flex-1">
                  ...
                  <div class="mt-1.5 flex items-center gap-3 text-sm">
                    ...
                    <span class="text-muted">
                      {{ t('admin.users.defaultRate') }}: <span class="font-medium text-foreground">{{ config.defaultRate }}x</span>
                    </span>
                  </div>
                </div>
                ...
                <div class="flex flex-shrink-0 items-center gap-3">
                  <label class="text-sm font-medium text-muted">{{ t('admin.users.customRate') }}</label>
                  <input
                    type="number"
                    step="0.001"
                    min="0.001"
        ...
        <div v-if="publicGroups.length > 0">
          <div class="mb-3 flex flex-wrap items-center gap-2">
            ...
            <span class="text-xs text-muted">({{ publicGroupConfigs.length }})</span>
            <label class="ml-auto flex cursor-pointer items-center gap-2 text-sm text-muted">
              <input
                type="checkbox"
          ...
          <p class="mb-3 text-xs text-muted">{{ t('admin.users.restrictPublicGroupsHint') }}</p>
          <div class="grid gap-3">
            <div
