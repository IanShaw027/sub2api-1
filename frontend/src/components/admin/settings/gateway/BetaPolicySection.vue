      ...
      <template v-else>
        ...
        >
          <div class="settings-flex-row mb-3 flex items-center gap-2">
            ...
            <span class="rounded bg-surface-2 px-2 py-0.5 text-xs text-muted">
              {{ rule.beta_token }}
            </span>
          </div>
          <div class="settings-rows">
            <!-- Action -->
            <SettingRow :label="t('admin.settings.betaPolicy.action')">
              <Select
            ...
            <!-- Scope -->
            <SettingRow :label="t('admin.settings.betaPolicy.scope')">
              <Select
