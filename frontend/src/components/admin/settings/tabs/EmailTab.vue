<template>
  <div v-show="activeTab === 'email'" class="settings-stack">
    ...
    <SettingsSection v-if="!form.email_verify_enabled">
      <div class="settings-rows">
        <div class="settings-flex-row flex items-start gap-3 settings-block">
          <Icon name="mail" size="md" class="mt-0.5 flex-shrink-0 text-muted" />
          <div>
    ...
    <SettingsSection v-if="form.email_verify_enabled">
      ...
      <div class="settings-rows">
        <div class="settings-rows">
          <SettingRow :label="t('admin.settings.smtp.host')">
            <input
          ...
          <SettingRow :label="t('admin.settings.smtp.port')">
            <input
          ...
          <SettingRow :label="t('admin.settings.smtp.username')">
            <input
          ...
          <SettingRow :label="t('admin.settings.smtp.fromEmail')">
            <input
          ...
          <SettingRow :label="t('admin.settings.smtp.fromName')">
            <input
        ...
        <SettingRow
          ...
          :description="t('admin.settings.smtp.useTlsHint')"
        >
    ...
    >
      <div class="settings-rows">
        <div
          class="settings-flex-row settings-control-row flex items-center justify-between gap-4 settings-block"
        >
    ...
    >
      <form id="send-test-email-form" @submit.prevent="sendTestEmail">
    ...
    <SettingsSection>
      ...
      <div class="settings-rows">
        <SettingRow :label="t('admin.settings.balanceNotify.enabled')">
          <Toggle v-model="form.balance_low_notify_enabled" />
        </SettingRow>
        <SettingRow
          v-if="form.balance_low_notify_enabled"
        ...
        <SettingRow :label="t('admin.settings.balanceNotify.rechargeUrl')">
          <input
    ...
    <SettingsSection>
      ...
      <div class="settings-rows">
        <SettingRow :label="t('admin.settings.quotaNotify.enabled')">
          <Toggle v-model="form.account_quota_notify_enabled" />
        </SettingRow>
        <SettingRow
          v-if="form.account_quota_notify_enabled"
          :label="t('admin.settings.quotaNotify.emails')"
        >
          <div class="space-y-2">
            <div
