  ...
  <div v-show="activeTab === 'users'" class="settings-stack">
    ...
    >
      ...
      <div class="settings-rows">
        <div class="space-y-4 settings-block">
          <div
          ...
          >
            <div
              class="settings-flex-row settings-control-row flex items-center justify-between gap-4"
            >
              <div>
            ...
            >
              ...
              <div v-else class="space-y-3">
                <div
                  v-for="(item, index) in authSourceDefaults[authSource.source]
                    .subscriptions"
