  ...
  <div v-show="activeTab === 'features'" class="settings-stack">
    ...
    <SettingsSection>
      ...
      <SettingRow
        ...
        :label="t('admin.settings.features.channelMonitor.mode')"
      >
        <div
          class="inline-flex w-full max-w-md rounded-lg border border-line bg-surface-2 p-1"
        >
          <button
            type="button"
      ...
      <SettingRow
        v-if="
          form.channel_monitor_enabled && form.channel_monitor_mode === 'v1'
        "
      ...
      <SettingRow
        v-if="
          form.channel_monitor_enabled && form.channel_monitor_mode === 'v2'
        "
    ...
    >
      ...
      <template v-if="form.affiliate_enabled">
        ...
        <div class="settings-rows">
          <SettingRow
            :label="t('admin.settings.features.affiliate.customUsers.title')"
            :description="
          ...
          <div
            class="settings-flex-row mb-3 flex items-center gap-2 settings-block"
          >
            <input
            ...
            >
              {{
                t("admin.settings.features.affiliate.customUsers.batchButton", {
          ...
          <div
            class="overflow-x-auto rounded-lg border border-line settings-block"
          >
          ...
          <div
            ...
            class="settings-flex-row settings-control-row mt-3 flex items-center justify-between text-sm settings-block"
          >
            <span class="text-muted">
              {{
                t("admin.settings.features.affiliate.customUsers.totalLabel", {
            ...
            <div class="settings-flex-row flex items-center gap-2">
              ...
              <span class="text-muted"
                ...
                {{
                  Math.max(
                    1,
                    Math.ceil(affiliateState.total / affiliateState.pageSize),
                  )
                }}</span
              >
              <button
    ...
    >
      <div class="w-full max-w-md glass-card-solid rounded-hero p-6">
        ...
        <div
          class="settings-flex-row settings-control-row mt-6 flex items-center justify-between gap-3"
        >
