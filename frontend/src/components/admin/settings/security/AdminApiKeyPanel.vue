<template>
  ...
  >
    <div class="settings-rows">
      <!-- Security Warning -->
      <div
        class="rounded-lg border border-warning bg-[color-mix(in_oklch,var(--warning)_10%,transparent)] p-4 settings-block"
      >
      ...
      <div
        ...
        class="settings-flex-row settings-control-row flex items-center justify-between settings-block"
      >
        <span class="text-muted">
          {{ t("admin.settings.adminApiKey.notConfigured") }} </span
        ><button
          type="button"
      ...
      <!-- Key Exists -->
      <div v-else class="space-y-4 settings-block">
        <div
