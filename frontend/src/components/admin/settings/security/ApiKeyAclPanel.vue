  ...
  >
    <div class="settings-rows">
      <SettingRow
        ...
        :description="t('admin.settings.apiKeyAcl.trustForwardedIpHint')"
      >
        <Toggle v-model="form.api_key_acl_trust_forwarded_ip" />
      </SettingRow>
      <SettingRow
        v-if="form.api_key_acl_trust_forwarded_ip"
        :label="t('admin.settings.apiKeyAcl.forwardedClientIpHeaders')"
        label-for="forwarded-client-ip-headers"
      >
          ...
          <div class="settings-flex-row flex flex-wrap items-center gap-2">
            ...
            >
              ...
              <button
                ...
                :aria-label="
                  t('admin.settings.apiKeyAcl.removeForwardedClientIpHeader', {
                    header,
                  })
                "
