  ...
  >
    <div class="space-y-4">
      ...
      <div v-else-if="profiles.length === 0" class="py-8 text-center">
        <div class="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-surface-2">
          <Icon name="shield" size="lg" class="text-muted" />
        </div>
      ...
      <div v-else class="max-h-96 overflow-auto rounded-lg border border-line">
        <table class="min-w-full divide-y divide-line">
          <thead class="sticky top-0 bg-surface-2">
            <tr>
              <th class="px-3 py-2 text-left text-xs font-medium uppercase text-muted">
          ...
          <tbody class="divide-y divide-line bg-surface">
            <tr v-for="profile in profiles" :key="profile.id" class="hover:bg-surface-2">
              <td class="px-3 py-2">
                <div class="font-medium text-foreground text-sm">{{ profile.name }}</div>
              </td>
              <td class="px-3 py-2">
                <div v-if="profile.description" class="text-sm text-muted max-w-xs truncate">
                  {{ profile.description }}
                </div>
              ...
              <td class="px-3 py-2">
                <div v-if="profile.alpn_protocols?.length" class="flex flex-wrap gap-1">
                  ...
                  <span v-if="profile.alpn_protocols.length > 3" class="text-xs text-muted">
              ...
              <td class="px-3 py-2">
                <div class="flex items-center gap-1">
                  <button
                    ...
                    class="p-1 text-muted hover:text-accent"
                    :title="t('common.edit')"
                  >
                  ...
                  <button
                    ...
                    class="p-1 text-muted hover:text-danger-text"
        ...
        <div>
          ...
          <div class="mt-1 flex items-center gap-2">
            ...
            <p class="text-xs text-muted">
              ...
              <a href="https://tls.sub2api.org" target="_blank" rel="noopener noreferrer" class="text-accent hover:text-accent underline">{{ t('admin.tlsFingerprintProfiles.form.openCollector') }}</a>
            </p>
          </div>
        </div>
