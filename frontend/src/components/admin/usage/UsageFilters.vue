      ...
      <div class="flex flex-1 flex-wrap items-end gap-4">
        ...
        <div ref="userSearchRef" class="usage-filter-dropdown relative w-full sm:w-auto sm:min-w-[240px]">
          ...
          <button
            ...
            type="button"
            @click="clearUser"
            class="absolute right-2 top-9 text-ink-faint"
          ...
          >
            <button
              ...
              type="button"
              @click="selectUser(u)"
              class="w-full px-4 py-2 text-left text-ink hover:bg-page dark:hover:bg-dark-700"
            >
              <span>{{ u.email }}<span v-if="u.deleted" class="ml-1 text-xs text-ink-faint">（{{ t('admin.usage.userDeletedBadge') }}）</span></span>
              <span class="ml-2 text-xs text-ink-faint">#{{ u.id }}</span>
            </button>
          </div>
        </div>
        ...
        <div ref="apiKeySearchRef" class="usage-filter-dropdown relative w-full sm:w-auto sm:min-w-[240px]">
          ...
          >
            ...
            >
              ...
              <span class="ml-2 text-xs text-ink-faint">#{{ k.id }}</span>
            </button>
          </div>
        </div>
        ...
        <div ref="accountSearchRef" class="usage-filter-dropdown relative w-full sm:w-auto sm:min-w-[220px]">
          ...
          >
            ...
            >
              ...
              <span class="ml-2 text-xs text-ink-faint">#{{ a.id }}</span>
            </button>
          </div>
        </div>
