<template>
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    ...
    <div class="glass-card p-4 flex items-center gap-3">
      <div class="rounded-lg bg-amber-100 p-2 text-warning-text"><svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m21 7.5-9-5.25L3 7.5m18 0-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" /></svg></div>
      <div>
    ...
    <div class="glass-card p-4 flex items-center gap-3">
      <div class="rounded-lg bg-[color-mix(in_oklch,var(--success)_16%,transparent)] p-2 text-green-600">
