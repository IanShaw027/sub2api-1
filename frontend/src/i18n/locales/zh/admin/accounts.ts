export default {
    accounts: {
      ...
      oauthCapacity: {
        action: 'OAuth 容量',
        title: 'OpenAI OAuth 容量预警',
        hint: '席位健康度、5h/7d 剩余配额与双窗口燃尽率预警。未测到的指标显示为 —，不会伪造 $0。',
        accounts: 'OAuth 账号',
        schedulable: '可调度',
        errors: '错误',
        rateLimited: '限流中',
        ...
        scope: '范围',
        range: '时间范围',
        rateLimitDistribution: '限流剩余时间分布',
        hourlyTrend: '消耗 / 可用额度趋势',
        noTrendData: '暂无趋势数据',
        firstShortfall: '首次缺口',
        noShortfall: '暂无预计缺口',
        window5h: '5 小时窗口',
        ...
        alertWarning: '预警',
        alertCritical: '紧急',
        suggestAdd: '建议再补充 {count} 个账号',
        loadFailed: '加载 OAuth 容量失败'
      },
      capacityForecast: {
        action: '容量预测',
        title: '平台容量预测',
