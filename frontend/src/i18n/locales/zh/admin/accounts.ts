export default {
    accounts: {
      ...
      oauthCapacity: {
        ...
        confidence_low: '低',
        hourlyRate: '组合速率',
        planMix: '套餐与补号建议（各套餐为互斥备选，勿相加）',
        plan: '套餐',
        unit5h: '5h 单号',
        unit7d: '7d 单号',
        add5h: '5h 备选补号',
        add7d: '7d 备选补号',
        recommendationNote: '补号数为填平当前缺口的备选方案，请按单一套餐路径选择，勿将多套餐数量相加。',
        rateLimitDistribution: '限流剩余时间',
        recent3h: '最近 3 小时消耗',
        previousDay3h: '前日同期 3 小时消耗',
        blendedRate: '组合预测速率',
        loadFailed: '加载 OAuth 容量失败',
        range: '时间范围',
        windowToggle: '额度窗口',
        bothWindows: '双窗口',
        hourlyTrend: '每小时消耗 / 可用额度趋势',
        legendSpendSolid: '已消耗（实线）',
        legendSpendDashed: '预计消耗（虚线）',
        legendAvailable: '可用额度',
        legendAvailable7d: '可用额度 7d',
        noTrendData: '暂无趋势数据',
        chartSpend: '消耗',
        chartAvailable: '可用额度',
        chartAvailable7d: '可用额度 7d',
        chartCapacity: '推算总额度',
        untilReset: '至窗口重置',
        forecastInputs: '预测输入',
        rpmWindow: '近 15 分钟消耗',
        groupAllocationNote:
          '额度按账号共享池计算；分组视图按本窗口实际消耗占比分摊，不会把同一账号额度重复计给多个分组。历史为实线定格，未来为虚线预估；当前小时为已消耗与预计的合成值。',
        persistenceNote:
          '已结束的小时会落库定格，下次直接读历史表不再扫原始日志；无法推算的可用额度/容量不显示。当前小时为实时数据，不会定格。',
        sealedHour: '已定格（持久化）',
        unmeasured: '暂无可用推算'
      },
      columns: {
