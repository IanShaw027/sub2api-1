export default {
    ...
    usage: {
      ...
      clickToViewIps: '点击查看该用户 IP 明细',
      failedToLoadUser: '加载用户信息失败',
      userDeletedBadge: '已删除',
      ipSummaryTitle: '用户 IP 明细 — {user}',
      ipSummaryEmpty: '该时间范围内暂无 IP 记录',
      ipSummaryLoadFailed: '加载用户 IP 明细失败',
      ipRequests: '请求数',
      ipCost: '费用',
      sharedUsers: '共用用户',
      banIp: '封禁',
      ...
      ipPin: {
        ...
        enable: '开启出口锁定',
        disable: '关闭出口锁定',
        confirmEnable: '开启后，该用户只能使用历史出现过的 IP；陌生 IP 会被拒绝并全局封禁（可能误伤同 CGNAT 其他用户）。确定开启？',
        enabledToast: '已开启出口锁定',
        disabledToast: '已关闭出口锁定',
        failed: '更新出口锁定失败',
        hint: '开启后仅允许该用户历史 IP；陌生 IP 将 403 并全局封禁'
      },
      tokenRanking: {
