export default {
    ...
    dashboard: {
      ...
      heroRangeSummary: '所选时段请求 {requests} 次，消耗 {tokens} tokens，实际扣费 ${cost}，平均响应 {duration}',
      periodRequests: '时段请求数',
      periodTokens: '时段 Tokens',
      periodCost: '时段费用',
      currentSnapshot: '实时快照',
      currentInventory: '当前存量',
      expandDetails: '展开明细',
      collapseDetails: '收起明细',
      viewUsage: '查看用量记录',
      rankingLimit: '消费排名前 {count} 位',
    ...
    users: {
      ...
      disableApiKey: '禁用',
      enableApiKey: '解除禁用',
      disableApiKeyConfirm: '确定要禁用 API 密钥「{name}」吗？禁用后该密钥将无法调用。',
      enableApiKeyConfirm: '确定要解除禁用 API 密钥「{name}」吗？',
      apiKeyDisabledSuccess: 'API 密钥已禁用',
      apiKeyEnabledSuccess: 'API 密钥已解除禁用',
      apiKeyStatusUpdateFailed: '更新 API 密钥状态失败',
      noUsersYet: '暂无用户',
