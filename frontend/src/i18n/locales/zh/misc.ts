export default {
  ...
  payment: {
    ...
    invoices: {
      mine: '我的发票',
      adminDescription: '审核用户开票申请，上传并发送发票文件',
      totalLabel: '共计申请',
      apply: '申请开票',
      applySelected: '为 {count} 笔订单开票',
      applyHint: '将 {count} 笔已完成订单合并为一张发票。',
      fromOrders: '从订单勾选',
      select: '开票',
      id: '发票编号',
      title: '发票抬头',
      ...
      cancel: '撤销申请',
      download: '下载发票',
      confirmCancel: '确定要撤销此发票申请吗？',
      confirmDownload: '确认下载该发票文件？',
      uploadFile: '上传发票文件',
      issue: '开具发票',
      resendEmail: '重发邮件',
      search: '搜索发票',
    ...
    errors: {
      ...
      INVOICE_FORBIDDEN: '无权访问该发票',
      INVOICE_INVALID_STATUS: '当前发票状态不允许该操作',
      INVOICE_ORDER_NOT_ELIGIBLE: '仅已完成订单可以开票',
      INVOICE_CHANNEL_DISABLED: '该支付渠道未开启开票',
      INVOICE_ORDER_OCCUPIED: '所选订单中已有有效发票',
      INVOICE_TOO_MANY_ORDERS: '单张发票最多合并 100 笔订单',
      INVOICE_NO_ORDERS: '请至少选择一笔订单',
      INVOICE_ISSUED: '该订单已开具发票，需先红冲后再退款，或由管理员强制继续',
      INVOICE_TAX_NUMBER_REQUIRED: '发票税号必填',
      INVOICE_FILE_REQUIRED: '开具发票需要上传文件',
      INVOICE_FILE_INVALID: '发票文件无效或不是私有发票附件',
      INVOICE_TITLE_REQUIRED: '请填写发票抬头',
      INVOICE_EMAIL_REQUIRED: '请填写收票邮箱',
      INVOICE_EMAIL_INVALID: '收票邮箱格式不正确',
      INVOICE_MIXED_CURRENCY: '同一张发票只能合并相同币种的订单',
      INVOICE_TITLE_TOO_LONG: '发票抬头过长',
      INVOICE_FIELD_TOO_LONG: '发票字段超出允许长度',
    },
    ...
    admin: {
      ...
      ordersDescription: '管理充值与订阅订单、退款与对账',
      totalOrdersLabel: '共计订单',
      dashboardDescription: '收入、订单量与支付方式分布概览',
      plansDescription: '配置可售订阅套餐、价格与有效期',
      totalPlansLabel: '共计套餐',
      revenueTrendSub: '近 {days} 天收入与订单量走势',
      paymentDistributionSub: '按支付方式统计的收款金额',
      topUsersSub: '按累计消费金额排名',
      todayRevenue: '今日收入',
      totalRevenue: '总收入',
      todayOrders: '今日订单',
      orderCount: '订单数',
      ...
      confirmRefund: '确认退款',
      refundSuccess: '退款成功',
      invoiceRefundIssuedWarning: '该订单已开具发票。继续退款前请先完成红冲；勾选强制后仍可继续。',
  ...
  tickets: {
    ...
    detailTitle: '工单详情',
    create: '创建工单',
    createDescription: '选择工单类别并填写申请信息，提交后可在工单列表中跟进处理进度。',
    createBasicSection: '基本信息',
    createDetailsSection: '申请详情',
    submit: '提交工单',
    ticketNo: '工单号',
    user: '用户',
    categoryLabel: '分类',
    ...
    form: {
      ...
      targetRate: '目标倍率',
      details: '详细说明',
      rateHint: '勾选一个或多个标准计费分组，提交时会快照当前生效倍率。',
      baseRate: '基础倍率',
      effectiveRate: '生效倍率',
    },
    validation: {
    ...
    errors: {
      ...
      TICKET_CATEGORY_INVALID: '工单分类无效',
      TICKET_TITLE_INVALID: '工单标题无效',
      TICKET_PAYLOAD_REQUIRED: '请填写必填表单',
      TICKET_PAYLOAD_INVALID: '工单表单无效',
      TICKET_MESSAGE_REQUIRED: '请填写回复或上传附件',
      TICKET_NOT_EDITABLE: '当前状态不可编辑',
      TICKET_WITHDRAW_INVALID: '当前状态不可撤回',
      TICKET_CLOSE_INVALID: '当前状态不可关闭',
      TICKET_REPLY_LOCKED: '当前工单已锁定，不能回复',
      TICKET_FORBIDDEN: '无权访问该工单',
      TICKET_STATUS_LOCKED: '工单状态已锁定',
      TICKET_STATUS_TRANSITION_INVALID: '需客服先回复后才能切到该状态',
      TICKET_REVISION_REQUIRED: '需要提供工单版本号',
      TICKET_REVISION_CONFLICT: '工单已被其他人更新，请刷新后重试',
      TICKET_ATTACHMENT_INVALID: '附件不是有效的工单文件',
      TICKET_ATTACHMENT_LIMIT: '附件数量超过限制',
    },
  },
