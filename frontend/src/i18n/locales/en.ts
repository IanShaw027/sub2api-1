export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      openAIWebProfileTitle: 'OpenAI WebProfile',
      openAIWebProfileSafeHint: 'Safe browser profile metadata only. Cookie values are never rendered here.',
      openAIWebProfileImportLabel: 'Import WebProfile',
      openAIWebProfileImportPlaceholder: 'Paste exported WebProfile JSON or text content',
      openAIWebProfileImportHint: 'Paste content only; no complex upload is required.',
      openAIWebProfileImportSubmit: 'Import WebProfile',
      openAIWebProfileImporting: 'Importing...',
      openAIWebProfileFieldHasWebProfile: 'Has WebProfile',
      openAIWebProfileFieldSource: 'Source',
      openAIWebProfileFieldCapturedAt: 'Captured At',
      openAIWebProfileFieldUAMajor: 'UA Major',
      openAIWebProfileFieldHasCookieJar: 'Has Cookie Jar',
      openAIWebProfileFieldCookieNamesDigest: 'Cookie Names Digest',
      openAIWebProfileFieldProxyId: 'Proxy ID',
      openAIWebProfileFieldProxyHash: 'Proxy Hash',
      ...
      imageTestRouteHint: 'Explicitly choose the codex or web2api path.',
      imageTestRouteOptionCodex: 'codex',
      imageTestRouteOptionWeb2API: 'web2api',
  ...
  payment: {
    ...
    invoice: {
      ...
      searchPlaceholder: 'Search invoice applications...',
      batch: {
        ...
        submit: 'Submit',
        submitting: 'Submitting...',
        allSuccess: 'All applications submitted successfully',
        partialFail: '{success} succeeded, {failed} failed',
        resultTitle: 'Batch Invoice Results',
        statusApplied: 'Applied',
        statusSkipped: 'Skipped (already applied/issued)',
        statusError: 'Failed',
        clearSelection: 'Clear Selection',
        maxExceeded: 'Maximum 100 orders per batch',
      },
    },
