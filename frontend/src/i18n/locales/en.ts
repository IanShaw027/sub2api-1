  ...
  admin: {
    ...
    settings: {
      ...
      features: {
        ...
        ticket: {
          title: 'Ticket System',
          description: 'Enable user support tickets and related admin workflows.',
          enabled: 'Enable Ticket System',
          enabledHint: 'When disabled, ticket entry points are hidden and ticket routes are blocked.',
        },
      },
      ...
      gatewayForwarding: {
        ...
        debugTimelineHint: 'Persist structured forwarding traces to local files for troubleshooting request pipelines.',
        debugTimelineDirectory: 'Trace Directory',
        debugTimelineDirectoryHint: 'Relative or absolute path used to store timeline files.',
        debugTimelineRetentionDays: 'Retention (days)',
        debugTimelineMaxSizeMB: 'Max Directory Size (MB)',
