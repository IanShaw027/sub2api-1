  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        grokDefaultBaseURLModeHint: 'Affects text inference only (responses/chat). "api" = official Public API; "cli" = Grok Build CLI proxy. Image/video Imagine always uses api.x.ai; usage/billing always uses the CLI proxy. Explicit per-account base_url wins for inference.',
        grokDefaultBaseURLModeAPI: 'Official API (api.x.ai/v1, default)',
