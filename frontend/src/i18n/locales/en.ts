export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      kiro: {
        manualUpdateAction: 'Update Credentials',
        manualUpdateDialogTitle: 'Update Kiro Credentials',
        manualUpdateTitle: 'Manual credential update only',
        manualUpdateDesc: 'Kiro does not have a supported admin-side OAuth re-authorization flow on this backend. Update the stored credentials manually in the account editor.',
