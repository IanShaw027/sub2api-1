export default {
  ...
  payment: {
    ...
    invoices: {
      mine: 'My Invoices',
      adminDescription: 'Review invoice requests, upload and deliver invoice files',
      totalLabel: 'Total requests',
      apply: 'Apply for Invoice',
      applySelected: 'Invoice {count} orders',
      applyHint: 'Merge {count} completed orders into one invoice.',
      fromOrders: 'Select from orders',
      select: 'Invoice',
      id: 'Invoice ID',
      title: 'Invoice Title',
      amount: 'Amount',
      ...
      download: 'Download',
      confirmCancel: 'Are you sure you want to cancel this invoice application?',
      confirmDownload: 'Download this invoice file?',
    ...
    errors: {
      ...
      INVOICE_FORBIDDEN: 'You cannot access this invoice.',
      INVOICE_INVALID_STATUS: 'This invoice status does not allow that action.',
      INVOICE_ORDER_NOT_ELIGIBLE: 'Only completed orders can be invoiced.',
      INVOICE_CHANNEL_DISABLED: 'Invoicing is not enabled for this payment channel.',
      INVOICE_ORDER_OCCUPIED: 'One of the selected orders already has an active invoice.',
      INVOICE_TOO_MANY_ORDERS: 'At most 100 orders can be merged into one invoice.',
      INVOICE_NO_ORDERS: 'Select at least one order.',
      INVOICE_ISSUED: 'This order already has an issued invoice. Complete a red-flush (红冲) first, or an administrator can force the refund.',
      INVOICE_TAX_NUMBER_REQUIRED: 'Invoice tax number is required.',
      INVOICE_FILE_REQUIRED: 'Upload an invoice file to issue it.',
      INVOICE_FILE_INVALID: 'The uploaded file is not a valid private invoice document.',
      INVOICE_TITLE_REQUIRED: 'Invoice title is required.',
      INVOICE_EMAIL_REQUIRED: 'Invoice email is required.',
      INVOICE_EMAIL_INVALID: 'Invoice email is invalid.',
      INVOICE_MIXED_CURRENCY: 'Orders in one invoice must use the same currency.',
      INVOICE_TITLE_TOO_LONG: 'Invoice title is too long.',
      INVOICE_FIELD_TOO_LONG: 'An invoice field exceeds the allowed length.',
    },
    ...
    admin: {
      ...
      ordersDescription: 'Manage top-up and subscription orders, refunds and reconciliation',
      totalOrdersLabel: 'Total orders',
      dashboardDescription: 'Revenue, order volume and payment method breakdown',
      plansDescription: 'Configure sellable subscription plans, pricing and validity',
      totalPlansLabel: 'Total plans',
      revenueTrendSub: 'Revenue and order volume over the last {days} days',
      paymentDistributionSub: 'Amount collected per payment method',
      topUsersSub: 'Ranked by total spend',
      ...
      invoiceRefundIssuedWarning: 'This order has an issued invoice. Complete a red-flush (红冲) first, or force the refund to continue.',
  ...
  tickets: {
    ...
    createDescription: 'Choose a category and fill in the request details, then track its progress from the ticket list.',
    createBasicSection: 'Basic Information',
    createDetailsSection: 'Request Details',
    ...
    pickTemplate: 'Insert a quick reply',
    templates: {
      button: 'Templates',
    ...
    status: {
      ...
      waiting_admin: 'Waiting on staff',
      resolved: 'Resolved',
      closed: 'Closed',
      withdrawn: 'Withdrawn',
    },
    ...
    form: {
      ...
      currentConcurrency: 'Current concurrency',
      targetConcurrency: 'Requested concurrency',
      usageScenario: 'Usage scenario',
      targetRate: 'Requested rate',
      details: 'Details',
      rateHint: 'Select one or more standard billing groups. Effective rates are snapshotted on submit.',
      baseRate: 'Base',
    ...
    errors: {
      ...
      TICKET_TITLE_INVALID: 'Ticket title is invalid.',
      TICKET_PAYLOAD_REQUIRED: 'Complete the required form fields.',
      TICKET_PAYLOAD_INVALID: 'Ticket form is invalid.',
      TICKET_MESSAGE_REQUIRED: 'Enter a message or attach a file.',
      TICKET_NOT_EDITABLE: 'This ticket cannot be edited now.',
      TICKET_WITHDRAW_INVALID: 'This ticket cannot be withdrawn now.',
      TICKET_CLOSE_INVALID: 'This ticket cannot be closed now.',
      TICKET_REPLY_LOCKED: 'This ticket no longer accepts replies.',
      TICKET_FORBIDDEN: 'You cannot access this ticket.',
      TICKET_STATUS_LOCKED: 'This ticket status can no longer be changed.',
      TICKET_STATUS_TRANSITION_INVALID: 'That status change is not allowed until staff replies.',
      TICKET_REVISION_REQUIRED: 'Ticket revision is required.',
      TICKET_REVISION_CONFLICT: 'This ticket was updated elsewhere. Refresh and try again.',
      TICKET_ATTACHMENT_INVALID: 'That attachment is not a valid ticket file.',
      TICKET_ATTACHMENT_LIMIT: 'Too many attachments on this reply.',
    },
  },
