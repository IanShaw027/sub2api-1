export default {
  dashboard: {
    ...
    heroPeriodLead: 'Selected period: ',
    heroPeriodSummary: 'Selected period: {tokens} tokens consumed, ${cost} spent',
  ...
  usage: {
    ...
    predicted7dTotal: 'Predicted 7d total (USD)',
    sevenDayForecast: '7d forecast by utilization',
    rateLimit429: '429 count',
    sessions: 'Sessions',
    resetNow: 'Now',
