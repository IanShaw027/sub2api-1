export default {
    ...
    usage: {
      ...
      clickToViewIps: 'Click to view this user\'s IP summary',
      failedToLoadUser: 'Failed to load user info',
      userDeletedBadge: 'Deleted',
      ipSummaryTitle: 'User IP summary — {user}',
      ipSummaryEmpty: 'No IP records in this time range',
      ipSummaryLoadFailed: 'Failed to load user IP summary',
      ipRequests: 'Requests',
      ipCost: 'Cost',
      ...
      ipStatus: {
        ...
        pinnedBan: 'Pinned-exit ban',
        whitelisted: 'Whitelisted',
        released: 'Released'
      },
      ipPin: {
        enabled: 'Historical exits locked',
        disabled: 'Exit lock off',
        enable: 'Enable exit lock',
        disable: 'Disable exit lock',
        confirmEnable: 'After enabling, this user may only use previously seen IPs. Unknown IPs are rejected and globally banned (may affect other users on the same CGNAT). Continue?',
        enabledToast: 'Exit lock enabled',
        disabledToast: 'Exit lock disabled',
        failed: 'Failed to update exit lock',
        hint: 'Only historical IPs are allowed; unknown IPs get 403 and a global ban'
      },
      tokenRanking: {
