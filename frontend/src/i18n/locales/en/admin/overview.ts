export default {
    ...
    dashboard: {
      ...
      trendCacheCreation: 'Cache Creation',
      trendCacheRead: 'Cache Read',
      trendCacheHitRate: 'Cache Hit Rate',
      ...
      standard: 'Standard',
      accountCost: 'Cost',
      balanceCost: 'Wallet spend',
      subscriptionCost: 'Subscription spend',
      ...
      heroTitleLead: 'All good, ',
      heroTitleAlertLead: 'Needs attention, ',
      heroTitleTail: ' accounts online',
      heroSummary: '{requests} requests today, {tokens} tokens used, est. ${cost} spent, avg response {duration}',
      heroRangeSummary: 'Selected period: {requests} requests, {tokens} tokens, ${cost} charged, avg response {duration}',
      periodRequests: 'Period requests',
      periodTokens: 'Period tokens',
      periodCost: 'Period cost',
      currentSnapshot: 'Live snapshot',
      currentInventory: 'Current inventory',
      expandDetails: 'Expand details',
      collapseDetails: 'Collapse details',
      viewUsage: 'View usage records',
      rankingLimit: 'Top {count} spenders',
      heroAllHealthy: ', all services are running normally.',
      heroIssues: ', {error} errors and {ratelimit} rate-limited accounts need attention.',
      viewOpsMonitor: 'View Ops Monitor',
      handleAbnormalAccounts: 'Handle Abnormal Accounts',
      serviceStatus: 'Service Status',
      realtimeRpm: 'Live RPM',
      realtimeTpm: 'Live TPM',
      todayNew: '+{count} today',
      activeRatio: '{rate}% active',
      abnormalCount: '{count} abnormal',
      accountsHealthy: 'All accounts healthy',
      statusError: 'Error',
      statusRateLimited: 'Rate limited',
      cacheHitRate: '{rate}% cache hit',
      requestTrend: 'Request Trend',
      trendSubtitle: 'Last {count} {unit}, total {total}',
      unitHour: 'hours',
      unitDay: 'days',
      costShort: 'Cost',
      platformHealth: 'Platform Health',
      recentEvents: 'Recent Events',
      noPlatformHealth: 'No platform data',
      noPlatformHealthDesc: 'No platform accounts connected yet',
      noEvents: 'No events',
      noEventsDesc: 'System is running smoothly with no recent events',
      healthOk: '{ok}/{total} ok',
      healthRateLimited: '{count} rate-limited',
      healthError: '{count} errors',
      todayLabel: 'Today',
    ...
    users: {
      ...
      enableApiKey: 'Enable',
      disableApiKeyConfirm: 'Disable API key "{name}"? It will stop working immediately.',
      enableApiKeyConfirm: 'Re-enable API key "{name}"?',
      apiKeyDisabledSuccess: 'API key disabled',
      apiKeyEnabledSuccess: 'API key enabled',
      apiKeyStatusUpdateFailed: 'Failed to update API key status',
