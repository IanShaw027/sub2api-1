export default {
    accounts: {
      ...
      oauthCapacity: {
        action: 'OAuth Capacity',
        title: 'OpenAI OAuth Capacity Alerts',
        hint: 'Seat health, 5h/7d remaining quota, and dual-window burn-rate alerts. Unmeasured metrics show — instead of a fake $0.',
        ...
        burnRate: 'Burn rate',
        resetAt: 'Reset',
        exhaustsAt: 'Projected exhaust',
        measured: '{count} measured accounts',
        ...
        scope: 'Scope',
        range: 'Range',
        rateLimitDistribution: 'Rate-limit remaining time',
        hourlyTrend: 'Spend / available trend',
        noTrendData: 'No trend data yet',
        firstShortfall: 'First shortfall',
        noShortfall: 'No shortfall expected',
        window5h: '5-hour window',
        window7d: '7-day window',
        alertWarning: 'Warning',
        alertCritical: 'Critical',
        suggestAdd: 'Suggest adding {count} more accounts',
        loadFailed: 'Failed to load OAuth capacity'
      },
      capacityForecast: {
