export default {
    accounts: {
      ...
      oauthCapacity: {
        ...
        title: 'OpenAI OAuth Capacity by Group',
        scope: 'Scope',
        allGroups: 'All groups (deduplicated)',
        accounts: 'OAuth Accounts',
        schedulable: 'Schedulable',
        errors: 'Errors',
        rateLimited: 'Rate Limited',
        windows: '5h / 7d Capacity',
        window: 'Window',
        spent: 'Spent',
        ...
        forecastRemaining: 'Forecast Addl.',
        ...
        confidence_low: 'Low',
        hourlyRate: 'Blended Rate',
        planMix: 'Plans and Refill Guidance (alternative plan paths, not additive)',
        plan: 'Plan',
        unit5h: '5h / Account',
        unit7d: '7d / Account',
        add5h: '5h alt. refill',
        add7d: '7d alt. refill',
        recommendationNote: 'Refill counts are alternative ways to close the current gap. Choose a single plan path; do not add quantities across plan types.',
        rateLimitDistribution: 'Rate-limit Time Remaining',
        recent3h: 'Recent 3-hour Spend',
        previousDay3h: 'Previous-day Same-period Spend',
        blendedRate: 'Blended Forecast Rate',
        loadFailed: 'Failed to load OAuth capacity',
        range: 'Time Range',
        windowToggle: 'Quota Window',
        bothWindows: 'Both',
        hourlyTrend: 'Hourly Spend / Available Trend',
        legendSpendSolid: 'Spent (solid)',
        legendSpendDashed: 'Forecast (dashed)',
        legendAvailable: 'Available',
        legendAvailable7d: 'Available 7d',
        noTrendData: 'No trend data yet',
        chartSpend: 'Spend',
        chartAvailable: 'Available',
        chartAvailable7d: 'Available 7d',
        chartCapacity: 'Est. Capacity',
        untilReset: 'until window reset',
        forecastInputs: 'Forecast Inputs',
        rpmWindow: 'Last 15-min Spend',
        groupAllocationNote:
          'Capacity is a shared account pool. Group views allocate by actual window spend share and never double-count the full physical quota. Past hours are solid actuals; future hours are dashed forecasts; the current hour blends actual + remaining forecast.',
        persistenceNote:
          'Completed hours are sealed in the hourly facts table and reused without re-scanning usage logs. Metrics that cannot be measured are omitted. The current hour is live and never sealed.',
        sealedHour: 'Sealed (persisted)',
