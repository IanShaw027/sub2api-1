export default {
    settings: {
      ...
      ipSecurity: {
        ...
        description: 'Automatically blocks an IP when multiple accounts with no prior history on that IP access it within a short window. Users are not auto-disabled. Off by default, with a 72-hour learning period.',
        enable: 'Enable suspicious IP blocking',
        enableHint: 'When disabled, new detections stop while existing bans remain enforced.',
        windowMinutes: 'Detection window (minutes)',
        accountThreshold: 'Account threshold',
