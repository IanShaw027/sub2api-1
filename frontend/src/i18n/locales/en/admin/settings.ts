export default {
    settings: {
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for Clomio end-user login',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on Clomio orders; the upstream type is sent as EasyPay type.',
