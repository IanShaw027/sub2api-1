export default {
  common: {
    ...
    switchToLocale: 'Switch language to {locale}',
    userMenu: 'User menu',
  ...
  nav: {
    ...
    apiKeys: 'API Keys',
    studio: 'Studio',
    creation: { chat: 'Chat', image: 'Images', video: 'Videos', voice: 'Voice', gallery: 'Inspiration' },
    ...
    section: {
      overview: 'Overview',
      usersResources: 'Users & Resources',
      channels: 'Channels',
