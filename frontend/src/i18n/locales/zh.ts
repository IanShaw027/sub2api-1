export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      openAIWebProfileSafeHint: '这里只显示安全的浏览器 Profile 元数据，不会渲染任何 Cookie 值。',
      openAIWebProfileImportLabel: '导入 WebProfile',
      openAIWebProfileImportPlaceholder: '粘贴导出的 WebProfile JSON 或文本内容',
      openAIWebProfileImportHint: '只需粘贴内容，不需要复杂上传。',
      openAIWebProfileImportSubmit: '导入 WebProfile',
      openAIWebProfileImporting: '导入中...',
      openAIWebProfileFieldHasWebProfile: '是否有 WebProfile',
      openAIWebProfileFieldSource: '来源',
      openAIWebProfileFieldCapturedAt: '采集时间',
      openAIWebProfileFieldUAMajor: 'UA 主版本',
      openAIWebProfileFieldHasCookieJar: '是否有 Cookie Jar',
      openAIWebProfileFieldCookieNamesDigest: 'Cookie 名摘要',
      openAIWebProfileFieldProxyId: '代理 ID',
      openAIWebProfileFieldProxyHash: '代理哈希',
      openAIWebProfileImported: 'OpenAI WebProfile 导入成功',
      openAIWebProfileImportFailed: '导入 OpenAI WebProfile 失败',
      ...
      imageTestRouteHint: '显式选择 codex 或 web2api 路径。',
  ...
  payment: {
    ...
    invoice: {
      ...
      batch: {
        ...
        submitting: '提交中...',
        allSuccess: '全部申请成功',
        partialFail: '{success} 笔成功，{failed} 笔失败',
        resultTitle: '批量开票结果',
        statusApplied: '已申请',
        statusSkipped: '已跳过（已申请/已开具）',
        statusError: '失败',
        clearSelection: '清除选择',
