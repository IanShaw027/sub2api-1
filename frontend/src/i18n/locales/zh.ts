  ...
  admin: {
    ...
    settings: {
      ...
      features: {
        ...
        ticket: {
          title: '工单系统',
          description: '启用用户工单及后台处理流程。',
          enabled: '启用工单系统',
          enabledHint: '关闭后工单入口会隐藏，相关路由将被拦截。',
        },
      },
      ...
      gatewayForwarding: {
        ...
        debugTimelineHint: '将请求转发的结构化调试轨迹写入本地文件，便于排查转发链路问题。',
        debugTimelineDirectory: '轨迹目录',
        debugTimelineDirectoryHint: '用于保存时间线文件的相对或绝对路径。',
        debugTimelineRetentionDays: '保留天数',
        debugTimelineMaxSizeMB: '目录最大容量（MB）',
