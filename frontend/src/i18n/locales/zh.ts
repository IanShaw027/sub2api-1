  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        grokDefaultBaseURLModeHint: '仅影响文本推理（responses/chat）。api 走官方 Public API；cli 走 Grok Build CLI 代理。图片/视频 Imagine 始终走 api.x.ai；usage/billing 始终走 CLI 代理。账号显式 base_url 对推理优先。',
        grokDefaultBaseURLModeAPI: '官方 API（api.x.ai/v1，默认）',
